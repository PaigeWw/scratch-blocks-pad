...
Blockly.Css.CONTENT = [
  ...
  '.blocklyNumPadButton {',
    ...
    'margin: 4px;',
    'border-radius: 4px;',
    'background: $colour_numPadButtonBackground;',
  ...
  */
  ...
  'background-image: url(<<<PATH>>>/trashopen.png);',
  '}',
  ...
  '.blocklyToolboxDiv {',
    ...
    'box-shadow: 2px 2px 10px #aa78e2;',
    // 'overflow-x: visible;',
    // 'overflow-y: auto;',
    'position: absolute;',
    'font-family: "Helvetica Neue", Helvetica, sans-serif;',
