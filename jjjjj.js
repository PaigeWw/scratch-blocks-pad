...
Blockly.VariableModel = function(a, b, c) {
  this.name = a;
  this.type = b || "";
  this.id_ = c || Blockly.utils.genUid()
  ...
  a && (d = g.indexOf(a));
  c && (e = g.indexOf(c)); - 1 == d && -1 == e ? (this.createVariable(b, ""), console.log("Tried to rename an non-existent variable.")) : d == e || -1 != d && -1 == e ? this.variableMap_[f][d].name = b: -1 != d && -1 != e && (this.variableMap_[f][e].name = b, this.variableMap_[f].splice(d, 1))
  ...
  b = b || "";
  d = new Blockly.VariableModel(a, b, c);
  ...
  return (a = this.variableMap_[a || ""]) ? a: []
...
Blockly.Workspace = function(a) {
  ...
  if (a.toLowerCase() != Blockly.Variables.noVariableText()) return this.variableMap_.createVariable(a, b, c)
...
}; Blockly.Workspace.prototype.deleteVariableById = function(a) { (a = this.getVariableById(a)) && this.deleteVariableInternal_(a)
  ...
  for (var b = this.listeners_.slice(), c = 0, d; d = b[c]; c++) d(a)
}; Blockly.Workspace.prototype.getBlockById = function(a) {
  var b = this.blockDB_[a]; ! b && this.getFlyout() && this.getFlyout().getWorkspace() && (b = this.getFlyout().getWorkspace().blockDB_[a]);
  return b || null
...
Blockly.Comment = function(a) {
  ...
  var b = this,
    ...
    d = a.getSourceBlock(),
    e = !1;
  b == c.getFirstStatementConnection() && (e = !0);
  if (a.isConnected()) {
    if (e) var f = a.targetConnection;
    a.disconnect()
  }
  if (b.isConnected()) {
    var g = b.targetBlock(),
      h = b.getShadowDom();
    b.setShadowDom(null);
    if (g.isShadow()) h = Blockly.Xml.blockToDom(g),
      g.dispose(),
      g = null;
    else if (b.type == Blockly.NEXT_STATEMENT) {
      if (!g.previousConnection) throw "Orphan block does not have a previous connection.";
      for (var k = d; k.nextConnection;) {
        var l = k.getNextBlock();
        if (l && !l.isShadow()) k = l;
        else {
          g.previousConnection.checkType_(k.nextConnection) && (k.nextConnection.connect(g.previousConnection), g = null);
          break
        }
      }
    }
    if (g && (b.disconnect(), Blockly.Events.recordUndo)) {
      var m = Blockly.Events.getGroup();
      setTimeout(function() {
          g.workspace && !g.getParent() && (Blockly.Events.setGroup(m), g.outputConnection ? g.outputConnection.bumpAwayFrom_(b) : g.previousConnection && g.previousConnection.bumpAwayFrom_(b), Blockly.Events.setGroup(!1))
        },
        Blockly.BUMP_DELAY)
    }
    b.setShadowDom(h)
  }
  e && f && f.connect(c.previousConnection);
  var n;
  ...
  var b = this.sourceBlock_.getFirstStatementConnection(),
    c = this == b,
    d = this == this.sourceBlock_.nextConnection;
  if (null != b && !c && !d) return ! 1;
  if (c) return ! 0;
  if (d) {
  ...
  switch (a.type) {
    ...
    case Blockly.NEXT_STATEMENT:
      if (b && this == this.sourceBlock_.previousConnection && a.isConnectedToNonInsertionMarker() && !b.targetConnection || a.isConnectedToNonInsertionMarker() && !this.sourceBlock_.nextConnection && !a.targetBlock().isShadow() && a.targetBlock().nextConnection) return ! 1;
      break;
    default:
  ...
  return this.check_ ? -1 !== this.check_.indexOf("Boolean") ? Blockly.OUTPUT_SHAPE_HEXAGONAL: -1 !== this.check_.indexOf("Number") ? Blockly.OUTPUT_SHAPE_ROUND: -1 !== this.check_.indexOf("String") ? Blockly.OUTPUT_SHAPE_SQUARE: Blockly.OUTPUT_SHAPE_ROUND: Blockly.OUTPUT_SHAPE_ROUND
...
}; Blockly.constants = {}; Blockly.DRAG_RADIUS = 3; Blockly.FLYOUT_DRAG_RADIUS = 10; Blockly.SNAP_RADIUS = 48; Blockly.CONNECTING_SNAP_RADIUS = 96; Blockly.CURRENT_CONNECTION_PREFERENCE = 20; Blockly.BUMP_DELAY = 0; Blockly.COLLAPSE_CHARS = 30; Blockly.LONGPRESS = 750; Blockly.SOUND_LIMIT = 100; Blockly.DRAG_STACK = !0; Blockly.HSV_SATURATION = .45; Blockly.HSV_VALUE = .65; Blockly.SPRITE = {
  width: 96,
  height: 124,
  url: "sprites.png"
}; Blockly.SVG_NS = "http://www.w3.org/2000/svg"; Blockly.HTML_NS = "http://www.w3.org/1999/xhtml"; Blockly.INPUT_VALUE = 1; Blockly.OUTPUT_VALUE = 2; Blockly.NEXT_STATEMENT = 3; Blockly.PREVIOUS_STATEMENT = 4; Blockly.DUMMY_INPUT = 5; Blockly.ALIGN_LEFT = -1; Blockly.ALIGN_CENTRE = 0; Blockly.ALIGN_RIGHT = 1; Blockly.DRAG_NONE = 0; Blockly.DRAG_STICKY = 1; Blockly.DRAG_BEGIN = 1; Blockly.DRAG_FREE = 2; Blockly.OPPOSITE_TYPE = []; Blockly.OPPOSITE_TYPE[Blockly.INPUT_VALUE] = Blockly.OUTPUT_VALUE; Blockly.OPPOSITE_TYPE[Blockly.OUTPUT_VALUE] = Blockly.INPUT_VALUE; Blockly.OPPOSITE_TYPE[Blockly.NEXT_STATEMENT] = Blockly.PREVIOUS_STATEMENT; Blockly.OPPOSITE_TYPE[Blockly.PREVIOUS_STATEMENT] = Blockly.NEXT_STATEMENT; Blockly.TOOLBOX_AT_TOP = 0; Blockly.TOOLBOX_AT_BOTTOM = 1; Blockly.TOOLBOX_AT_LEFT = 2; Blockly.TOOLBOX_AT_RIGHT = 3; Blockly.OUTPUT_SHAPE_HEXAGONAL = 1; Blockly.OUTPUT_SHAPE_ROUND = 2; Blockly.OUTPUT_SHAPE_SQUARE = 3; Blockly.STACK_GLOW_RADIUS = 1.3; Blockly.REPLACEMENT_GLOW_RADIUS = 2; Blockly.Categories = {
  motion: "motion",
  looks: "looks",
  sound: "sounds",
  pen: "pen",
  ...
  return Blockly.DropDownDiv.show(this, f, a, f, e, c)
  ...
  b = Blockly.DropDownDiv.getPositionMetrics(b, c, d, e);
  Blockly.DropDownDiv.arrow_.style.transform = "translate(" + b.arrowX + "px," + b.arrowY + "px) rotate(45deg)";
  Blockly.DropDownDiv.arrow_.setAttribute("class", b.arrowAtTop ? "blocklyDropDownArrow arrowTop": "blocklyDropDownArrow arrowBottom");
  a.style.left = b.initialX + "px";
  a.style.top = b.initialY + "px";
  a.style.display = "block";
  a.style.opacity = 1;
  a.style.transform = "translate(" + (b.finalX - b.initialX) + "px," + (b.finalY - b.initialY) + "px)";
  return b.arrowAtTop
}; Blockly.DropDownDiv.getPositionMetrics = function(a, b, c, d) {
  var e = Blockly.DropDownDiv.DIV_,
    f = Blockly.DropDownDiv.boundsElement_.getBoundingClientRect(),
    g = goog.style.getSize(Blockly.DropDownDiv.boundsElement_),
    e = goog.style.getSize(e);
  if (b + e.height > f.top + g.height) if (d - e.height < f.top) {
    c = b + Blockly.DropDownDiv.PADDING_Y;
    var h = !1
  } else a = c,
    c = d - e.height - Blockly.DropDownDiv.PADDING_Y,
    h = !0;
  else c = b + Blockly.DropDownDiv.PADDING_Y,
    h = !1;
  var k = a - Blockly.DropDownDiv.ARROW_SIZE / 2,
    k = Math.max(f.left, Math.min(k, f.left + g.width));
  a = Math.max(f.left, Math.min(a - e.width / 2, f.left + g.width - e.width));
  k = Math.max(Blockly.DropDownDiv.ARROW_HORIZONTAL_PADDING, Math.min(k - a, e.width - Blockly.DropDownDiv.ARROW_HORIZONTAL_PADDING - Blockly.DropDownDiv.ARROW_SIZE));
  f = h ? e.height - Blockly.DropDownDiv.BORDER_SIZE: 0;
  f -= Blockly.DropDownDiv.ARROW_SIZE / 2 + Blockly.DropDownDiv.BORDER_SIZE;
  return {
    initialX: a,
    initialY: h ? d - e.height: b,
    finalX: a,
    finalY: c,
    arrowX: k,
    arrowY: f,
  ...
  return ! 1
}; Blockly.Events.Abstract.prototype.run = function() {}; Blockly.Events.Create = function(a) {
  ...
  var a = "m -20,0 h 5 " + Blockly.BlockSvg.NOTCH_PATH_LEFT + " h 5";
  ...
  this.localConnection_ = this.closestConnection_ = null;
  this.firstMarker_ && (this.firstMarker_.dispose(), this.firstMarker_ = null);
  this.lastMarker_ && (this.lastMarker_.dispose(), this.lastMarker_ = null);
  this.highlightedBlock_ = null
  ...
  this.closestConnection_ && (Blockly.Events.disable(), this.hidePreview_(), Blockly.Events.enable(), this.localConnection_.connect(this.closestConnection_), this.rendered && (this.localConnection_.isSuperior() ? this.closestConnection_: this.localConnection_).getSourceBlock().connectionUiEffect())
  ...
  var b = this.workspace_.newBlock(a.type);
  if (a.mutationToDom) {
    var c = a.mutationToDom();
    b.domToMutation(c)
  }
  b.setInsertionMarker(!0, a.width);
  b.initSvg();
  return b
  ...
  if (c && d) {
    ...
    if (this.localConnection_ && this.closestConnection_) {
      if (this.closestConnection_ == d) return ! 1;
      var c = this.localConnection_.x_ + b.x - this.closestConnection_.x_,
        f = this.localConnection_.y_ + b.y - this.closestConnection_.y_,
        c = Math.sqrt(c * c + f * f);
  ...
  return b.type == Blockly.OUTPUT_VALUE ? !0 : b == b.sourceBlock_.getFirstStatementConnection() ? !1 : !this.topBlock_.nextConnection && b.type == Blockly.PREVIOUS_STATEMENT && a.isConnected() ? !0 : !1
  ...
  if (!this.wouldDeleteBlock_) {
    var b = a.closest;
    a = a.local;
    b && b != this.closestConnection_ && !b.sourceBlock_.isInsertionMarker() && (this.closestConnection_ = b, this.localConnection_ = a, this.showPreview_())
  }
  ...
  if (this.markerConnection_) {
    ...
    a != c || d && d.targetConnection ? a.type == Blockly.NEXT_STATEMENT && a != c ? (c = a.targetConnection, c.sourceBlock_.unplug(!1), d = d ? d.targetConnection: null, b.unplug(!0), d && d.connect(c)) : b.unplug(!0) : a.targetBlock().unplug(!1);
  ...
  var a = new Blockly.Events.Move(this.draggingBlock_);
  ...
  if (this.flyout_ && this.flyout_.autoClose) Blockly.Events.getGroup() || Blockly.Events.setGroup(!0),
    this.flyout_.createBlock(this.targetBlock_).scheduleSnapAndBump();
  else if (!Blockly.WidgetDiv.isVisible() && !Blockly.DropDownDiv.isVisible()) {
    Blockly.Events.fire(new Blockly.Events.Ui(this.startBlock_, "click", void 0, void 0));
    var a = this.startBlock_.getRootBlock();
    Blockly.Events.fire(new Blockly.Events.Ui(a, "stackclick", void 0, void 0))
  }
  this.bringBlockToFront_();
  Blockly.Events.setGroup(!1)
  ...
  return (this.startField_ ? this.startField_.isCurrentlyEditable() : !1) && !this.hasExceededDragRadius_
  ...
  return c.join("")
}; Blockly.utils.measureText = function(a, b, c, d) {
  var e = document.createElement("canvas").getContext("2d");
  e.font = c + " " + a + " " + b;
  return e.measureText(d).width
}; Blockly.utils.encodeEntities = function(a) {
  return a.replace(/[\u00A0-\u9999<>\&]/gim,
    function(a) {
  ...
  if (g) {
    var h = null;
    var k = b = c = d = e = f = !1
  } else a.toolbox || (k = (new DOMParser).parseFromString(Blockly.Blocks.defaultToolbox, "text/xml"), a.toolbox = k.documentElement),
  ...
  var w = !!a.realtime,
    x = w ? a.realtimeOptions: void 0,
    t = a.colours;
  if (t) for (var u in t) t.hasOwnProperty(u) && Blockly.Colours.hasOwnProperty(u) && (Blockly.Colours[u] = t[u]);
  this.RTL = l;
  ...
  this.enableRealtime = w;
  this.realtimeOptions = x;
  ...
  else if (Blockly.Scrollbar.metricsAreEquivalent_(a, this.oldHostMetrics_)) return;
  this.oldHostMetrics_ = a;
  ...
  if (a != this.origin_.x || b != this.origin_.y) this.origin_ = new goog.math.Coordinate(a, b),
    this.originHasChanged_ = !0
  ...
  for (var g = 0; g < e; g++) {
    ...
    if ("block" == k || "shadow" == k && !Blockly.Events.recordUndo) {
      k = Blockly.Xml.domToBlock(h, b);
      c.push(k.id);
      var l = parseInt(h.getAttribute("x"), 10),
        h = parseInt(h.getAttribute("y"), 10);
      isNaN(l) || isNaN(h) || k.moveBy(b.RTL ? d - l: l, h)
    } else if ("shadow" == k) goog.asserts.fail("Shadow block cannot be a top-level block.");
    else if ("variables" == k) if (1 == g) Blockly.Xml.domToVariables(h, b);
    else throw Error("'variables' tag must be the first element in theworkspace XML, but it was found in another location.");
  }
  ...
  try {
    ...
    if (b.rendered) {
      ...
      b.isFlyout ? setTimeout(function() {
          d.workspace && (goog.userAgent.IE || goog.userAgent.EDGE) && d.render()
        },
        1) : setTimeout(function() {
          d.workspace && (d.setConnectionsHidden(!1), (goog.userAgent.IE || goog.userAgent.EDGE) && d.render())
        },
        1);
      d.updateDisabled();
      b.resizeContents()
...
Blockly.ZoomControls = function(a) {
  this.workspace_ = a
}; Blockly.ZoomControls.prototype.ZOOM_IN_PATH_ = "zoom-in.svg"; Blockly.ZoomControls.prototype.ZOOM_OUT_PATH_ = "zoom-out.svg"; Blockly.ZoomControls.prototype.ZOOM_RESET_PATH_ = "zoom-reset.svg"; Blockly.ZoomControls.prototype.WIDTH_ = 36; Blockly.ZoomControls.prototype.HEIGHT_ = 124; Blockly.ZoomControls.prototype.MARGIN_BETWEEN_ = 8; Blockly.ZoomControls.prototype.MARGIN_BOTTOM_ = 12; Blockly.ZoomControls.prototype.MARGIN_SIDE_ = 12; Blockly.ZoomControls.prototype.svgGroup_ = null; Blockly.ZoomControls.prototype.left_ = 0; Blockly.ZoomControls.prototype.top_ = 0; Blockly.ZoomControls.prototype.createDom = function() {
  var a = this.workspace_;
  this.svgGroup_ = Blockly.utils.createSvgElement("g", {
      "class": "blocklyZoom"
    },
    null);
  var b = Blockly.utils.createSvgElement("image", {
      width: this.WIDTH_,
      height: this.WIDTH_,
      y: 0
    },
    this.svgGroup_);
  b.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", a.options.pathToMedia + this.ZOOM_IN_PATH_);
  var c = Blockly.utils.createSvgElement("image", {
      width: this.WIDTH_,
      height: this.WIDTH_,
      y: 1 * this.WIDTH_ + 1 * this.MARGIN_BETWEEN_
    },
    this.svgGroup_);
  c.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", a.options.pathToMedia + this.ZOOM_OUT_PATH_);
  var d = Blockly.utils.createSvgElement("image", {
      width: this.WIDTH_,
      height: this.WIDTH_,
      y: 2 * this.WIDTH_ + 2 * this.MARGIN_BETWEEN_
    },
    this.svgGroup_);
  d.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", a.options.pathToMedia + this.ZOOM_RESET_PATH_);
  ...
  Blockly.bindEventWithChecks_(b, "mousedown", null,
    function(b) {
      a.markFocused();
      a.zoomCenter(1);
      Blockly.Touch.clearTouchIdentifier();
...
Blockly.WorkspaceSvg = function(a, b, c) {
  ...
  a ? (this.render(), this.resize()) : (Blockly.hideChaff(!0), Blockly.DropDownDiv.hideWithoutAnimation())
  ...
  if (d = a ? this.getBlockById(a) : null)(c = void 0 === b || b) ? -1 == this.highlightedBlocks_.indexOf(d) && this.highlightedBlocks_.push(d) : goog.array.remove(this.highlightedBlocks_, d),
    d.setHighlighted(c)
}; Blockly.WorkspaceSvg.prototype.glowBlock = function(a, b) {
  var c = null;
  if (a && (c = this.getBlockById(a), !c)) throw "Tried to glow block that does not exist.";
  c.setGlowBlock(b)
}; Blockly.WorkspaceSvg.prototype.glowStack = function(a, b) {
  var c = null;
  if (a && (c = this.getBlockById(a), !c)) throw "Tried to glow stack on block that does not exist.";
  c.setGlowStack(b)
}; Blockly.WorkspaceSvg.prototype.reportValue = function(a, b) {
  var c = this.getBlockById(a);
  if (!c) throw "Tried to report value on block that does not exist.";
  Blockly.DropDownDiv.hideWithoutAnimation();
  Blockly.DropDownDiv.clearContent();
  var d = Blockly.DropDownDiv.getContentDiv(),
    e = goog.dom.createElement("div");
  e.setAttribute("class", "valueReportBox");
  e.innerHTML = Blockly.utils.encodeEntities(b);
  d.appendChild(e);
  ...
  if (this.rendered) {
    ...
    Blockly.Events.disable();
    try {
      var c = Blockly.Xml.domToBlock(a, this);
      for (var d = c.getDescendants(), e = d.length - 1; 0 <= e; e--) {
        for (var f = d[e], g = 0; g < f.inputList.length; g++) if (b = f.inputList[g].connection) {
          var h = b.getShadowDom();
          h && (h.setAttribute("id", Blockly.utils.genUid()), b.setShadowDom(h))
        } (goog.userAgent.IE || goog.userAgent.EDGE) && f.render(!1)
      }
      ...
      if (!isNaN(k) && !isNaN(l)) {
        ...
        do {
          var m = !1;
          for (var n = this.getAllBlocks(), e = 0, p; p = n[e]; e++) {
            var q = p.getRelativeToSurfaceXY();
            if (1 >= Math.abs(k - q.x) && 1 >= Math.abs(l - q.y)) {
              m = !0;
              break
            }
          }
          if (!m) for (var r = c.getConnections_(!1), e = 0; b = r[e]; e++) if (b.closest(Blockly.SNAP_RADIUS, new goog.math.Coordinate(k, l)).connection) {
            m = !0;
            break
          }
          m && (k = this.RTL ? k - Blockly.SNAP_RADIUS: k + Blockly.SNAP_RADIUS, l += 2 * Blockly.SNAP_RADIUS)
        } while ( m );
        c.moveBy(k, l)
      }
    } finally {
  ...
  if (a.ctrlKey) {
    ...
    this.zoom(c.x, c.y, b)
  } else Blockly.WidgetDiv.hide(!0),
    Blockly.DropDownDiv.hideWithoutAnimation(),
    b = this.scrollX - a.deltaX,
    c = this.scrollY - a.deltaY,
  ...
  if (!this.options.readOnly && !this.isFlyout) {
    ...
    for (l = h = 0; l < p.length; l++) p[l].isShadow() || h++;
    h = {
      text: 1 == h ? Blockly.Msg.DELETE_BLOCK: Blockly.Msg.DELETE_X_BLOCKS.replace("%1", String(h)),
      enabled: 0 < h,
      callback: function() {
  ...
  this.scale != c && (this.scrollbar && (a = f.getCTM().translate(a * (1 - d), b * (1 - d)).scale(d), this.scrollX = a.e - e.absoluteLeft, this.scrollY = a.f - e.absoluteTop), this.setScale(c), Blockly.WidgetDiv.hide(!0), Blockly.DropDownDiv.hideWithoutAnimation())
  ...
  var c = this.startDragMetrics;
  a = Math.min(a, -c.contentLeft);
  b = Math.min(b, -c.contentTop);
  a = Math.max(a, c.viewWidth - c.contentLeft - c.contentWidth);
  b = Math.max(b, c.viewHeight - c.contentTop - c.contentHeight);
  Blockly.WidgetDiv.hide(!0);
  Blockly.DropDownDiv.hideWithoutAnimation();
  this.scrollbar.set( - a - c.contentLeft, -b - c.contentTop)
}; Blockly.WorkspaceSvg.prototype.updateStackGlowScale_ = function() {
  this.options.stackGlowBlur && this.options.stackGlowBlur.setAttribute("stdDeviation", Blockly.STACK_GLOW_RADIUS / this.scale)
  ...
  this.workspace_ = new Blockly.WorkspaceSvg(a, this.block_.workspace.dragSurface);
...
}; goog.global.Blockly || (goog.global.Blockly = {}); goog.global.Blockly.Mutator || (goog.global.Blockly.Mutator = {}); goog.global.Blockly.Mutator.reconnect = Blockly.Mutator.reconnect; Blockly.Extensions = {}; Blockly.Extensions.ALL_ = {}; Blockly.Extensions.MUTATOR_PROPERTIES_ = ["domToMutation", "mutationToDom", "compose", "decompose"]; Blockly.Extensions.register = function(a, b) {
...
}; Blockly.Extensions.register("parent_tooltip_when_inline", Blockly.Extensions.extensionParentTooltip_); Blockly.Field = function(a, b) {
...
}; Blockly.Field.cacheWidths_ = null; Blockly.Field.cacheReference_ = 0; Blockly.Field.prototype.name = void 0; Blockly.Field.prototype.text_ = ""; Blockly.Field.prototype.sourceBlock_ = null; Blockly.Field.prototype.visible_ = !0; Blockly.Field.prototype.argType_ = null; Blockly.Field.prototype.validator_ = null; Blockly.Field.NBSP = "\u00a0"; Blockly.Field.prototype.EDITABLE = !0; Blockly.Field.prototype.setSourceBlock = function(a) {
  ...
  if (!this.fieldGroup_) {
    ...
    null !== this.getArgTypes() && (this.sourceBlock_.isShadow() ? this.sourceBlock_.svgGroup_.setAttribute("data-argument-type", this.getArgTypes()) : this.fieldGroup_.setAttribute("data-argument-type", this.getArgTypes()));
    var a = this.getSize();
    this.textElement_ = Blockly.utils.createSvgElement("text", {
        "class": "blocklyText",
        x: this.sourceBlock_.RTL ? -a.width / 2 : a.width / 2,
        y: a.height / 2 + Blockly.BlockSvg.FIELD_TOP_PADDING,
...
}; Blockly.Field.prototype.addArgType = function(a) {
  null == this.argType_ && (this.argType_ = []);
  this.argType_.push(a)
}; Blockly.Field.prototype.getArgTypes = function() {
  return null === this.argType_ || 0 === this.argType_.length ? null: this.argType_.join(" ")
  ...
  if (this.visible_ && this.textElement_) {
    ...
    this.updateWidth();
    a = (this.size_.width - this.arrowWidth_) / 2;
    this.sourceBlock_.RTL && (a += this.arrowWidth_);
    if (this.sourceBlock_.isShadow() && !this.positionArrow) var b = Blockly.BlockSvg.FIELD_WIDTH / 2,
      a = this.sourceBlock_.RTL ? Math.min(this.size_.width - b, a) : Math.max(b, a);
    this.textElement_.setAttribute("x", a)
  }
  this.box_ && (this.box_.setAttribute("width", this.size_.width), this.box_.setAttribute("height", this.size_.height))
}; Blockly.Field.prototype.updateWidth = function() {
  Blockly.Field.getCachedWidth(this.textElement_);
  var a = Blockly.Field.getCachedWidth(this.textElement_);
  this.EDITABLE && (a += Blockly.BlockSvg.EDITABLE_FIELD_PADDING);
  this.arrowWidth_ = 0;
  this.positionArrow && (this.arrowWidth_ = this.positionArrow(a), a += this.arrowWidth_);
  this.box_ && (a += 2 * Blockly.BlockSvg.BOX_FIELD_PADDING);
  this.size_.width = a
  ...
  if (this.textElement_) {
    var a = this.text_;
    a.length > this.maxDisplayLength ? (a = a.substring(0, this.maxDisplayLength - 2) + "\u2026", this.textElement_.setAttribute("class", "blocklyText blocklyTextTruncated")) : this.textElement_.setAttribute("class", "blocklyText");
    goog.dom.removeChildren(this.textElement_);
    a = a.replace(/\s/g, Blockly.Field.NBSP);
...
}; Blockly.Field.prototype.setTooltip = function() {}; Blockly.Field.prototype.getClickTarget_ = function() {
  for (var a = 0,
         b = 0,
         c; c = this.sourceBlock_.inputList[b]; b++) a += c.fieldRow.length;
  return 1 >= a ? this.sourceBlock_.getSvgRoot() : this.getSvgRoot()
}; Blockly.Field.prototype.getAbsoluteXY_ = function() {
  return goog.style.getPageOffset(this.getClickTarget_())
}; Blockly.FieldVariableGetter = function(a, b) {
  Blockly.FieldVariableGetter.superClass_.constructor.call(this, a);
  this.name_ = b
}; goog.inherits(Blockly.FieldVariableGetter, Blockly.Field); Blockly.FieldVariableGetter.prototype.EDITABLE = !0; Blockly.FieldVariableGetter.prototype.init = function() {
  this.fieldGroup_ || (Blockly.FieldVariableGetter.superClass_.init.call(this), this.getValue() || this.setValue(Blockly.Variables.generateUniqueName(this.sourceBlock_.isInFlyout ? this.sourceBlock_.workspace.targetWorkspace: this.sourceBlock_.workspace)), this.sourceBlock_.isInFlyout || this.sourceBlock_.workspace.createVariable(this.getValue()))
}; Blockly.FieldVariableGetter.prototype.showEditor_ = function() {}; Blockly.FieldVariableGetter.prototype.updateEditable = function() {}; Blockly.FieldLabel = function(a, b) {
  ...
  var d = a && a.getFlyout && a.getFlyout() ? a.getFlyout().getWorkspace() : null;
  this.id = !c || a.getBlockById(c) || d && d.getBlockById(c) ? Blockly.utils.genUid() : c;
  ...
  this.checkboxInFlyout_ = this.collapsed_ = this.isShadow_ = !1;
  this.category_ = this.outputShape_ = this.comment = null;
...
}; Blockly.Block.prototype.data = null; Blockly.Block.prototype.colour_ = "#FF0000"; Blockly.Block.prototype.colourSecondary_ = "#FF0000"; Blockly.Block.prototype.colourTertiary_ = "#FF0000"; Blockly.Block.prototype.dispose = function(a) {
  if (this.workspace) {
  ...
  return null
}; Blockly.Block.prototype.getInputWithConnection = function(a) {
  for (var b = 0,
         c; c = this.inputList[b]; b++) if (c.connection == a) return c;
  return null
  ...
  for (var a = 0,
         b; b = this.inputList[a]; a++) if (b.connection && b.connection.type == Blockly.NEXT_STATEMENT) return b.connection;
  return null
  ...
  for (var b = [this], c, d = 0; c = this.childBlocks_[d]; d++) a && c.isShadow_ || b.push.apply(b, c.getDescendants(a));
  return b
  ...
  this.isInsertionMarker_ != a && (this.isInsertionMarker_ = a) && (this.setColour(Blockly.Colours.insertionMarker), this.setOpacity(Blockly.Colours.insertionMarkerOpacity), Blockly.utils.addClass(this.svgGroup_, "blocklyInsertionMarker"))
  ...
  if (c.length != d.length) throw "Connection lists did not match in length.";
...
}; Blockly.Block.prototype.makeColour_ = function(a) {
  var b = Number(a);
  if (isNaN(b)) {
    if (goog.isString(a) && a.match(/^#[0-9a-fA-F]{6}$/)) return a;
    throw "Invalid colour: " + a;
  }
  return Blockly.hueToRgb(b)
}; Blockly.Block.prototype.setColour = function(a, b, c) {
  this.colour_ = this.makeColour_(a);
  this.colourSecondary_ = void 0 !== b ? this.makeColour_(b) : goog.color.rgbArrayToHex(goog.color.darken(goog.color.hexToRgb(this.colour_), .1));
  this.colourTertiary_ = void 0 !== c ? this.makeColour_(c) : goog.color.rgbArrayToHex(goog.color.darken(goog.color.hexToRgb(this.colour_), .2));
  ...
  for (var a = [], b = 0, c; c = this.inputList[b]; b++) for (var d = 0,
                                                                e; e = c.fieldRow[d]; d++)(e instanceof Blockly.FieldVariable || e instanceof Blockly.FieldVariableGetter) && a.push(e.getValue());
  return a
}; Blockly.Block.prototype.renameVar = function(a, b) {
  for (var c = 0,
         d; d = this.inputList[c]; c++) for (var e = 0,
                                               f; f = d.fieldRow[e]; e++)(f instanceof Blockly.FieldVariable || f instanceof Blockly.FieldVariableGetter) && Blockly.Names.equals(a, f.getValue()) && f.setValue(b)
  ...
  void 0 !== a.colour && this.setColourFromJson_(a);
  ...
  if (Array.isArray(a.extensions)) {
    var c = a.extensions;
    for (b = 0; b < c.length; ++b) Blockly.Extensions.apply(c[b], this, !1)
  }
  void 0 !== a.outputShape && this.setOutputShape(a.outputShape);
  void 0 !== a.checkboxInFlyout && this.setCheckboxInFlyout(a.checkboxInFlyout);
  void 0 !== a.category && this.setCategory(a.category)
  ...
  goog.mixin(this, a)
}; Blockly.Block.prototype.setColourFromRawValues_ = function(a, b, c) {
  a = goog.isString(a) ? Blockly.utils.replaceMessageReferences(a) : a;
  b = goog.isString(b) ? Blockly.utils.replaceMessageReferences(b) : b;
  c = goog.isString(c) ? Blockly.utils.replaceMessageReferences(c) : c;
  this.setColour(a, b, c)
}; Blockly.Block.prototype.setColourFromJson_ = function(a) {
  this.setColourFromRawValues_(a.colour, a.colourSecondary, a.colourTertiary)
    ...
    do
      if (e = !1, "string" == typeof f) h = new Blockly.FieldLabel(f);
        ...
        case "field_textdropdown":
          h = new Blockly.FieldTextDropdown(f.text, f.options);
          "boolean" == typeof f.spellcheck && h.setSpellcheck(f.spellcheck);
          break;
        case "field_numberdropdown":
          h = new Blockly.FieldNumberDropdown(f.value, f.options, f.min, f.max, f.precision);
          break;
        case "field_angle":
        ...
        case "field_dropdown":
          ...
          break;
        case "field_iconmenu":
          h = new Blockly.FieldIconMenu(f.options);
          break;
        case "field_image":
        ...
        case "field_variable_getter":
          h = Blockly.Block.newFieldVariableGetterFromJson_(f);
          break;
        case "field_date":
  ...
  return new Blockly.FieldImage(b, c, d, e, !!a.flip_rtl)
...
}; Blockly.Block.newFieldVariableGetterFromJson_ = function(a) {
  var b = Blockly.utils.replaceMessageReferences(a.text);
  return new Blockly.FieldVariableGetter(b, a.name, a["class"])
...
}; Blockly.Block.prototype.setCategory = function(a) {
  this.category_ = a
}; Blockly.Block.prototype.getCategory = function() {
  return this.category_
}; Blockly.Block.prototype.setCheckboxInFlyout = function(a) {
  this.checkboxInFlyout_ = a
...
}; goog.inherits(Blockly.BlockSvg, Blockly.Block); Blockly.BlockSvg.prototype.height = 0; Blockly.BlockSvg.prototype.width = 0; Blockly.BlockSvg.prototype.insertionMarkerMinWidth_ = 0; Blockly.BlockSvg.prototype.opacity_ = 1; Blockly.BlockSvg.prototype.dragStartXY_ = null; Blockly.BlockSvg.prototype.isGlowingBlock_ = !1; Blockly.BlockSvg.prototype.isGlowingStack_ = !1; Blockly.BlockSvg.INLINE = -1; Blockly.BlockSvg.prototype.initSvg = function() {
  goog.asserts.assert(this.workspace.rendered, "Workspace is headless.");
  if (!this.isInsertionMarker()) {
    for (var a = 0,
           b; b = this.inputList[a]; a++) b.init(),
    b.type === Blockly.INPUT_VALUE && this.initInputShape(b);
    b = this.getIcons();
...
}; Blockly.BlockSvg.prototype.initInputShape = function(a) {
  this.inputShapes_[a.name] || a.connection.getShadowDom() || (this.inputShapes_[a.name] = Blockly.utils.createSvgElement("path", {
      "class": "blocklyPath",
...
}; Blockly.BlockSvg.prototype.setGlowBlock = function(a) {
  this.isGlowingBlock_ = a;
  this.updateColour()
}; Blockly.BlockSvg.prototype.setGlowStack = function(a) {
  this.isGlowingStack_ = a;
  a = this.getSvgRoot();
  this.isGlowingStack_ && !a.hasAttribute("filter") ? a.setAttribute("filter", "url(#blocklyStackGlowFilter)") : !this.isGlowingStack_ && a.hasAttribute("filter") && a.removeAttribute("filter")
  ...
  if (a != this.parentBlock_) {
    ...
    if (this.parentBlock_ && b) {
      ...
      Blockly.selected != this && (this.workspace.getCanvas().appendChild(b), this.translate(c.x, c.y))
    }
    Blockly.Field.startCache();
    Blockly.BlockSvg.superClass_.setParent.call(this, a);
    Blockly.Field.stopCache();
    a && (c = this.getRelativeToSurfaceXY(), a.getSvgRoot().appendChild(b), b = this.getRelativeToSurfaceXY(), this.moveConnections_(b.x - c.x, b.y - c.y), this.isShadow() && this.setColour(this.getColour(), this.getColourSecondary(), a.getColourTertiary()))
  }
  ...
  var c;
  goog.asserts.assert(!this.parentBlock_, "Block has parent.");
  var d = Blockly.Events.isEnabled();
  d && (c = new Blockly.Events.Move(this));
  var e = this.getRelativeToSurfaceXY();
  this.translate(e.x + a, e.y + b);
  this.moveConnections_(a, b);
  d && (c.recordNew(), Blockly.Events.fire(c));
  ...
  } else c = new goog.math.Coordinate(a.x, a.y),
    a = new goog.math.Coordinate(a.x + b.width, a.y + b.height);
  return {
    topLeft: c,
    bottomRight: a
  }
}; Blockly.BlockSvg.prototype.setOpacity = function(a) {
  this.opacity_ = a;
  this.rendered && this.updateColour()
  ...
  if (!this.workspace.options.readOnly && this.contextMenu) {
    ...
    if (this.isDeletable() && this.isMovable() && !b.isInFlyout) {
      ...
      var d = this.getDescendants(!0).length,
        e = this.getNextBlock();
      e && (d -= e.getDescendants(!0).length);
      d = {
  ...
  this.updateColour()
}; Blockly.BlockSvg.prototype.setInsertionMarker = function(a, b) {
  Blockly.BlockSvg.superClass_.setInsertionMarker.call(this, a);
  this.insertionMarkerMinWidth_ = b;
  this.updateColour()
  ...
  1 < e ? goog.dom.removeNode(a) : (a.setAttribute("transform", "translate(" + (a.translateX_ + (b ? -1 : 1) * a.bBox_.width * d / 2 * e) + "," + (a.translateY_ + a.bBox_.height * d * e) + ") scale(" + (1 - e) * d + ")"), setTimeout(function() {
    ...
    10))
}; Blockly.BlockSvg.prototype.disconnectUiEffect = function() {}; Blockly.BlockSvg.disconnectUiStop_ = function() {}; Blockly.BlockSvg.prototype.updateDisabled = function() {}; Blockly.BlockSvg.prototype.getCommentText = function() {
  ...
  if (this.workspace.isDragging()) {
    ...
    d = !1;
    if (goog.isString(a)) this.warning || (this.warning = new Blockly.Warning(this), d = !0),
      this.warning.setText(a, c);
    else if (this.warning && !c) this.warning.dispose(),
      d = !0;
    else if (this.warning) {
      d = this.warning.getText();
      this.warning.setText("", c);
      var f = this.warning.getText();
      f || this.warning.dispose();
      d = d != f
    }
...
}; Blockly.BlockSvg.prototype.setColour = function(a, b, c) {
  Blockly.BlockSvg.superClass_.setColour.call(this, a, b, c);
  this.rendered && this.updateColour()
  ...
  this.isShadow() && this.parentBlock_ && (a = this.parentBlock_.getColourTertiary(), this.inputList[0] && this.inputList[0].fieldRow[0] && this.inputList[0].fieldRow[0] instanceof Blockly.FieldColour && (a = Blockly.Colours.colourPickerStroke));
  this.svgPath_.setAttribute("stroke", a);
  a = this.isGlowingBlock_ || this.isShadow() ? this.getColourSecondary() : this.getColour();
  this.svgPath_.setAttribute("fill", a);
  this.svgPath_.setAttribute("fill-opacity", this.getOpacity());
  for (var b in this.inputShapes_) this.inputShapes_[b].setAttribute("fill", this.getColourTertiary());
  b = this.getIcons();
  for (a = 0; a < b.length; a++) b[a].updateColour();
  for (b = 0; a = this.inputList[b]; b++) for (var c = 0,
                                                 d; d = a.fieldRow[c]; c++) d.setText(null)
}; Blockly.BlockSvg.prototype.highlightForReplacement = function(a) {
  a ? (this.svgPath_.setAttribute("filter", "url(#blocklyReplacementGlowFilter)"), Blockly.utils.addClass(this.svgGroup_, "blocklyReplaceable")) : (this.svgPath_.removeAttribute("filter"), Blockly.utils.removeClass(this.svgGroup_, "blocklyReplaceable"))
}; Blockly.BlockSvg.prototype.highlightShapeForInput = function(a, b) {
  var c = this.getInputWithConnection(a);
  if (!c) throw "No input found for the connection";
  c = this.inputShapes_[c.name];
  b ? (c.setAttribute("filter", "url(#blocklyReplacementGlowFilter)"), Blockly.utils.addClass(this.svgGroup_, "blocklyReplaceable")) : (c.removeAttribute("filter"), Blockly.utils.removeClass(this.svgGroup_, "blocklyReplaceable"))
}; Blockly.BlockSvg.prototype.getHeightWidth = function() {
  var a = this.height,
    b = this.width,
    c = this.getNextBlock();
  c && (c = c.getHeightWidth(), a += c.height, a -= Blockly.BlockSvg.NOTCH_HEIGHT, b = Math.max(b, c.width));
  return {
    height: a,
    width: b
  }
  ...
  this.renderClassify_(); ! 1 !== a && ((a = this.getParent()) ? a.render(!0) : Blockly.resizeSvgContents(this.workspace));
  Blockly.Field.stopCache()
  ...
  for (var d = 0,
    ...
    var f = e.getSvgRoot();
    if (f) {
      var g = -e.getSize().height / 2;
      this.RTL ? (b -= e.renderSep + e.renderWidth, f.setAttribute("transform", "translate(" + b + "," + (c + g) + ")"), e.renderWidth && (b -= Blockly.BlockSvg.SEP_SPACE_X)) : (f.setAttribute("transform", "translate(" + (b + e.renderSep) + "," + (c + g) + ")"), e.renderWidth && (b += e.renderSep + e.renderWidth + Blockly.BlockSvg.SEP_SPACE_X));
      this.isInsertionMarker() && f.setAttribute("display", "none")
    }
  }
  return this.RTL ? -b: b
}; Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
  var b, c = this.inputList,
    d = [];
  d.rightEdge = 0;
  for (var e = d.bottomEdge = 0,
         f = !1,
         g = !1,
         h = !1,
         k = void 0,
         l = 0,
         m; m = c[l]; l++) if (m.isVisible()) {
    if (k && k != Blockly.NEXT_STATEMENT && m.type != Blockly.NEXT_STATEMENT) var n = d[d.length - 1];
    else k = m.type,
      n = [],
      n.type = m.type != Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.INLINE: m.type,
      n.height = 0,
      n.paddingStart = Blockly.BlockSvg.SEP_SPACE_X,
      n.paddingEnd = Blockly.BlockSvg.SEP_SPACE_X,
      d.push(n);
    n.push(m);
    1 === c.length && this.isShadow() && this.outputConnection ? m.renderHeight = Blockly.BlockSvg.MIN_BLOCK_Y_SINGLE_FIELD_OUTPUT: m.renderHeight = this.outputConnection ? Blockly.BlockSvg.MIN_BLOCK_Y_REPORTER: n.type == Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.MIN_STATEMENT_INPUT_HEIGHT: b && b.type == Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.EXTRA_STATEMENT_ROW_Y: Blockly.BlockSvg.MIN_BLOCK_Y;
    if (m.type != Blockly.INPUT_VALUE || m.connection && m.connection.isConnected()) m.renderWidth = 0;
    else switch (m.connection.getOutputShape()) {
      case Blockly.OUTPUT_SHAPE_SQUARE:
        m.renderWidth = Blockly.BlockSvg.INPUT_SHAPE_SQUARE_WIDTH;
        break;
      case Blockly.OUTPUT_SHAPE_ROUND:
        m.renderWidth = Blockly.BlockSvg.INPUT_SHAPE_ROUND_WIDTH;
        break;
      case Blockly.OUTPUT_SHAPE_HEXAGONAL:
        m.renderWidth = Blockly.BlockSvg.INPUT_SHAPE_HEXAGONAL_WIDTH;
        break;
      default:
        m.renderWidth = 0
    }
    n.statementNotchAtBottom = !0;
    m.connection && m.connection.type === Blockly.NEXT_STATEMENT && (b = m.connection.targetBlock()) && !b.lastConnectionInStack() && (n.statementNotchAtBottom = !1);
    if (m.connection) {
      b = m.connection.targetBlock();
      var p = 0;
      b ? (p = b.getHeightWidth(), b = p.height, p = p.width) : b = Blockly.BlockSvg.INPUT_SHAPE_HEIGHT;
      m.connection.type === Blockly.INPUT_VALUE && (b += 2 * Blockly.BlockSvg.INLINE_PADDING_Y);
      m.connection.type === Blockly.NEXT_STATEMENT && n.statementNotchAtBottom && (b -= Blockly.BlockSvg.NOTCH_HEIGHT);
      m.renderHeight = Math.max(m.renderHeight, b);
      m.renderWidth = Math.max(m.renderWidth, p)
    }
    n.height = Math.max(n.height, m.renderHeight);
    m.fieldWidth = 0;
    1 == d.length && (m.fieldWidth += this.RTL ? -a: a);
    b = !1;
    for (var p = 0,
           q; q = m.fieldRow[p]; p++) {
      0 != p && (m.fieldWidth += Blockly.BlockSvg.SEP_SPACE_X);
      var r = q.getSize();
      q.renderWidth = r.width;
      q.renderSep = b && q.EDITABLE ? Blockly.BlockSvg.SEP_SPACE_X: 0;
      m.fieldWidth += q.renderWidth + q.renderSep;
      n.height = Math.max(n.height, r.height);
      b = q.EDITABLE
    }
    n.type != Blockly.BlockSvg.INLINE && (n.type == Blockly.NEXT_STATEMENT ? (g = !0, e = Math.max(e, m.fieldWidth)) : n.type == Blockly.INPUT_VALUE ? f = !0 : n.type == Blockly.DUMMY_INPUT && (h = !0));
    b = n
  }
  this.computeOutputPadding_(d);
  d.statementEdge = Blockly.BlockSvg.STATEMENT_INPUT_EDGE_WIDTH + e;
  this.previousConnection || this.nextConnection ? d.rightEdge = Math.max(d.rightEdge, Blockly.BlockSvg.MIN_BLOCK_X) : this.outputConnection && (this.isShadow() ? d.rightEdge = Math.max(d.rightEdge, Blockly.BlockSvg.MIN_BLOCK_X_SHADOW_OUTPUT) : d.rightEdge = Math.max(d.rightEdge, Blockly.BlockSvg.MIN_BLOCK_X_OUTPUT));
  g && (d.rightEdge = Math.max(d.rightEdge, Blockly.BlockSvg.MIN_BLOCK_X_WITH_STATEMENT));
  for (l = 0; l < d.length; l++) d.bottomEdge += d[l].height;
  0 < this.insertionMarkerMinWidth_ && (d.rightEdge = Math.max(d.rightEdge, this.insertionMarkerMinWidth_));
  d.hasValue = f;
  d.hasStatement = g;
  d.hasDummy = h;
  return d
}; Blockly.BlockSvg.prototype.computeOutputPadding_ = function(a) {
  if (this.getOutputShape() && this.outputConnection && !this.isShadow() && !(1 < a.length)) {
    a = a[0];
    var b = this.getOutputShape();
    a.paddingStart = 0;
    a.paddingEnd = 0;
    var c = a[0];
    if (c.fieldRow[0]) var d = 0;
    else d = c.connection,
      d = d.targetConnection ? d.targetConnection.getSourceBlock().getOutputShape() : d.getOutputShape(),
    b == Blockly.OUTPUT_SHAPE_HEXAGONAL && d != Blockly.OUTPUT_SHAPE_HEXAGONAL && (c = c.renderHeight - Blockly.BlockSvg.MIN_BLOCK_Y_REPORTER, a.paddingStart += c / 2);
    a.paddingStart += Blockly.BlockSvg.SHAPE_IN_SHAPE_PADDING[b][d];
    c = a[a.length - 1];
    c.connection ? (d = c.connection, d = d.targetConnection ? d.targetConnection.getSourceBlock().getOutputShape() : d.getOutputShape(), b == Blockly.OUTPUT_SHAPE_HEXAGONAL && d != Blockly.OUTPUT_SHAPE_HEXAGONAL && (c = c.renderHeight - Blockly.BlockSvg.MIN_BLOCK_Y_REPORTER, a.paddingEnd += c / 2)) : d = 0;
    a.paddingEnd += Blockly.BlockSvg.SHAPE_IN_SHAPE_PADDING[b][d]
  }
}; Blockly.BlockSvg.prototype.renderDraw_ = function(a, b) {
  this.squareTopLeftCorner_ = this.startHat_ = !1;
  this.outputConnection || this.previousConnection || (this.startHat_ = this.squareTopLeftCorner_ = !0, b.rightEdge = Math.max(b.rightEdge, 100));
  this.edgeShapeWidth_ = 0;
  this.edgeShape_ = null;
  if (this.outputConnection) {
    var c = this.getOutputShape();
    if (c === Blockly.OUTPUT_SHAPE_HEXAGONAL || c === Blockly.OUTPUT_SHAPE_ROUND) this.edgeShapeWidth_ = b.bottomEdge / 2,
      this.edgeShape_ = c,
  ...
  var e = this.renderDrawRight_(d, c, b, a);
  this.renderDrawBottom_(d, c, e);
  ...
  var a = [];
  if (this.outputConnection) this.isShadow_ ? a.push("argument") : a.push("reporter"),
    this.edgeShape_ === Blockly.OUTPUT_SHAPE_HEXAGONAL ? a.push("boolean") : this.edgeShape_ === Blockly.OUTPUT_SHAPE_ROUND && a.push("round");
  else {
    for (var b = this.inputList,
           c = 0,
           d = 0,
           e; e = b[d]; d++) e.connection && e.connection.type === Blockly.NEXT_STATEMENT && c++;
    c && (a.push("c-block"), a.push("c-" + c));
    this.startHat_ ? a.push("hat") : c || a.push("stack");
    this.nextConnection || a.push("end")
  }
  this.svgGroup_.setAttribute("data-shapes", a.join(" "));
  this.getCategory() && this.svgGroup_.setAttribute("data-category", this.getCategory())
}; Blockly.BlockSvg.prototype.renderDrawTop_ = function(a, b, c) {
  this.squareTopLeftCorner_ ? (a.push("m 0,0"), this.startHat_ && a.push(Blockly.BlockSvg.START_HAT_PATH), this.edgeShapeWidth_ && a.push("m " + this.edgeShapeWidth_ + ",0")) : (a.push(Blockly.BlockSvg.TOP_LEFT_CORNER_START), a.push(Blockly.BlockSvg.TOP_LEFT_CORNER));
  this.previousConnection && (a.push("H", Blockly.BlockSvg.NOTCH_START_PADDING), a.push(Blockly.BlockSvg.NOTCH_PATH_LEFT), this.previousConnection.moveTo(b.x + (this.RTL ? -Blockly.BlockSvg.NOTCH_WIDTH: Blockly.BlockSvg.NOTCH_WIDTH), b.y));
  this.width = c
}; Blockly.BlockSvg.prototype.renderDrawRight_ = function(a, b, c, d) {
  for (var e, f, g, h = 0,
         k, l = 0,
         m; m = c[l]; l++) {
    e = m.paddingStart;
    0 == l && (e += this.RTL ? -d: d);
    if (m.type == Blockly.BlockSvg.INLINE) {
      for (var n = 0; g = m[n]; n++) if (f = e, e = h, e += m.height / 2, g.align != Blockly.ALIGN_LEFT && (k = c.rightEdge - g.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X, g.align == Blockly.ALIGN_RIGHT ? f += k: g.align == Blockly.ALIGN_CENTRE && (f += k / 2)), e = this.renderFields_(g.fieldRow, f, e), g.type == Blockly.INPUT_VALUE) {
        0 === l && this.previousConnection && (e = Math.max(e, Blockly.BlockSvg.NO_PREVIOUS_INPUT_X_MIN));
        f = this.RTL ? b.x - e: b.x + e;
        var p = m.height / 2;
        k = b.y + h + p;
        g.connection.moveTo(f, k);
        g.connection.isConnected() && g.connection.tighten_();
        this.renderInputShape_(g, e, h + p);
        e += g.renderWidth + Blockly.BlockSvg.SEP_SPACE_X
      }
      e -= Blockly.BlockSvg.SEP_SPACE_X;
      e += m.paddingEnd;
      c.rightEdge = Math.max(e, c.rightEdge);
      e = Math.max(e, c.rightEdge);
      this.width = Math.max(this.width, e);
      this.edgeShape_ ? a.push("H", e - this.edgeShapeWidth_) : (a.push("H", e - Blockly.BlockSvg.CORNER_RADIUS - this.edgeShapeWidth_), a.push(Blockly.BlockSvg.TOP_RIGHT_CORNER));
      this.edgeShape_ || a.push("v", m.height - 2 * Blockly.BlockSvg.CORNER_RADIUS)
    } else m.type == Blockly.NEXT_STATEMENT && (g = m[0], f = e, e = h, this.renderFields_(g.fieldRow, f, e), a.push(Blockly.BlockSvg.BOTTOM_RIGHT_CORNER), e = c.statementEdge + Blockly.BlockSvg.NOTCH_WIDTH, a.push("H", e + Blockly.BlockSvg.STATEMENT_INPUT_INNER_SPACE + 2 * Blockly.BlockSvg.CORNER_RADIUS), a.push(Blockly.BlockSvg.NOTCH_PATH_RIGHT), a.push("h", "-" + Blockly.BlockSvg.STATEMENT_INPUT_INNER_SPACE), a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER), a.push("v", m.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER), m.statementNotchAtBottom && (a.push("h ", Blockly.BlockSvg.STATEMENT_INPUT_INNER_SPACE), a.push(Blockly.BlockSvg.NOTCH_PATH_LEFT)), a.push("H", c.rightEdge - Blockly.BlockSvg.CORNER_RADIUS), f = b.x + (this.RTL ? -e: e), k = b.y + h, g.connection.moveTo(f, k), g.connection.isConnected() && (g.connection.tighten_(), this.width = Math.max(this.width, c.statementEdge + g.connection.targetBlock().getHeightWidth().width)), l == c.length - 1 || c[l + 1].type == Blockly.NEXT_STATEMENT) && (a.push(Blockly.BlockSvg.TOP_RIGHT_CORNER), a.push("v", Blockly.BlockSvg.EXTRA_STATEMENT_ROW_Y - 2 * Blockly.BlockSvg.CORNER_RADIUS), h += Blockly.BlockSvg.EXTRA_STATEMENT_ROW_Y);
    h += m.height
  }
  this.edgeShape_ && (this.edgeShape_ === Blockly.OUTPUT_SHAPE_ROUND ? a.push("a " + this.edgeShapeWidth_ + " " + this.edgeShapeWidth_ + " 0 0 1 0 " + 2 * this.edgeShapeWidth_) : this.edgeShape_ === Blockly.OUTPUT_SHAPE_HEXAGONAL && a.push("l " + this.edgeShapeWidth_ + " " + this.edgeShapeWidth_ + " l " + -this.edgeShapeWidth_ + " " + this.edgeShapeWidth_));
  c.length || (h = Blockly.BlockSvg.MIN_BLOCK_Y, a.push("V", h));
  return h
}; Blockly.BlockSvg.prototype.renderInputShape_ = function(a, b, c) {
  var d = this.inputShapes_[a.name];
  if (d) if (a.connection.targetConnection) d.setAttribute("style", "visibility: hidden");
  else {
    switch (a.connection.getOutputShape()) {
      case Blockly.OUTPUT_SHAPE_HEXAGONAL:
        a = Blockly.BlockSvg.INPUT_SHAPE_HEXAGONAL;
        var e = Blockly.BlockSvg.INPUT_SHAPE_HEXAGONAL_WIDTH;
        var f = "boolean";
        break;
      case Blockly.OUTPUT_SHAPE_ROUND:
        a = Blockly.BlockSvg.INPUT_SHAPE_ROUND;
        e = Blockly.BlockSvg.INPUT_SHAPE_ROUND_WIDTH;
        f = "round";
        break;
      default:
        a = Blockly.BlockSvg.INPUT_SHAPE_SQUARE,
          e = Blockly.BlockSvg.INPUT_SHAPE_SQUARE_WIDTH,
          f = "square"
    }
    b = this.RTL ? -b - e: b;
    c -= Blockly.BlockSvg.INPUT_SHAPE_HEIGHT / 2;
    d.setAttribute("d", a);
    d.setAttribute("transform", "translate(" + b + "," + c + ")");
    d.setAttribute("data-argument-type", f);
    d.setAttribute("style", "visibility: visible")
  }
}; Blockly.BlockSvg.prototype.renderDrawBottom_ = function(a, b, c) {
  this.height = c;
  this.edgeShape_ || a.push(Blockly.BlockSvg.BOTTOM_RIGHT_CORNER);
  this.nextConnection && (a.push("H", Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.NOTCH_START_PADDING + Blockly.BlockSvg.CORNER_RADIUS, " "), a.push(Blockly.BlockSvg.NOTCH_PATH_RIGHT), this.nextConnection.moveTo(this.RTL ? b.x - Blockly.BlockSvg.NOTCH_WIDTH: b.x + Blockly.BlockSvg.NOTCH_WIDTH, b.y + c), this.nextConnection.isConnected() && this.nextConnection.tighten_(), this.height += Blockly.BlockSvg.NOTCH_HEIGHT);
  this.edgeShape_ ? a.push("H", this.edgeShapeWidth_) : (a.push("H", Blockly.BlockSvg.CORNER_RADIUS), a.push(Blockly.BlockSvg.BOTTOM_LEFT_CORNER))
}; Blockly.BlockSvg.prototype.renderDrawLeft_ = function(a, b) {
  this.outputConnection && this.outputConnection.moveTo(b.x, b.y + this.height / 2);
  this.edgeShape_ && (this.edgeShape_ === Blockly.OUTPUT_SHAPE_ROUND ? a.push("a " + this.edgeShapeWidth_ + " " + this.edgeShapeWidth_ + " 0 0 1 0 -" + 2 * this.edgeShapeWidth_) : this.edgeShape_ === Blockly.OUTPUT_SHAPE_HEXAGONAL && a.push("l " + -this.edgeShapeWidth_ + " " + -this.edgeShapeWidth_ + " l " + this.edgeShapeWidth_ + " " + -this.edgeShapeWidth_));
  a.push("z")
}; Blockly.BlockSvg.prototype.positionNewBlock = function(a, b, c) {
  b.type == Blockly.NEXT_STATEMENT && a.moveBy(c.x_ - b.x_, c.y_ - b.y_)
  ...
  this.setRestrictor(c);
  this.addArgType("text")
}; goog.inherits(Blockly.FieldTextInput, Blockly.Field); Blockly.FieldTextInput.ANIMATION_TIME = .25; Blockly.FieldTextInput.TEXT_MEASURE_PADDING_MAGIC = 45; Blockly.FieldTextInput.prototype.CURSOR = "text"; Blockly.FieldTextInput.prototype.spellcheck_ = !0; Blockly.FieldTextInput.prototype.init = function() {
  ...
  this.spellcheck_ = a
}; Blockly.FieldTextInput.prototype.setRestrictor = function(a) {
  this.restrictor_ = a
}; Blockly.FieldTextInput.prototype.showEditor_ = function(a, b, c, d) {
  ...
  b = Blockly.WidgetDiv.DIV;
  b.className += " fieldTextInput";
  var f = goog.dom.createDom("INPUT", "blocklyHtmlInput");
  f.setAttribute("spellcheck", this.spellcheck_);
  e && f.setAttribute("readonly", "true");
  Blockly.FieldTextInput.htmlInput_ = f;
  b.appendChild(f);
  c && (this.sourceBlock_.RTL ? f.style.paddingLeft = this.arrowSize_ + Blockly.BlockSvg.DROPDOWN_ARROW_PADDING + "px": f.style.paddingRight = this.arrowSize_ + Blockly.BlockSvg.DROPDOWN_ARROW_PADDING + "px", c = goog.dom.createDom("IMG", "blocklyTextDropDownArrow"), c.setAttribute("src", Blockly.mainWorkspace.options.pathToMedia + "dropdown-arrow-dark.svg"), c.style.width = this.arrowSize_ + "px", c.style.height = this.arrowSize_ + "px", c.style.top = this.arrowY_ + "px", c.style.cursor = "pointer", this.sourceBlock_.RTL ? c.style.left = "11px": c.style.right = "11px", d && (f.dropDownArrowMouseWrapper_ = Blockly.bindEvent_(c, "mousedown", this, d)), b.appendChild(c));
  f.value = f.defaultValue = this.text_;
  f.oldValue_ = null;
  this.validate_();
  this.resizeEditor_();
  a || (f.focus(), f.select(), f.setSelectionRange(0, 99999));
  f.onKeyDownWrapper_ = Blockly.bindEventWithChecks_(f, "keydown", this, this.onHtmlInputKeyDown_);
  f.onKeyUpWrapper_ = Blockly.bindEventWithChecks_(f, "keyup", this, this.onHtmlInputChange_);
  f.onKeyPressWrapper_ = Blockly.bindEventWithChecks_(f, "keypress", this, this.onHtmlInputChange_);
  f.onInputWrapper_ = Blockly.bindEvent_(f, "input", this, this.onHtmlInputChange_);
  f.onWorkspaceChangeWrapper_ = this.resizeEditor_.bind(this);
  this.workspace_.addChangeListener(f.onWorkspaceChangeWrapper_);
  d = "box-shadow " + Blockly.FieldTextInput.ANIMATION_TIME + "s";
  Blockly.BlockSvg.FIELD_TEXTINPUT_ANIMATE_POSITIONING && (b.style.transition += ",padding " + Blockly.FieldTextInput.ANIMATION_TIME + "s,width " + Blockly.FieldTextInput.ANIMATION_TIME + "s,height " + Blockly.FieldTextInput.ANIMATION_TIME + "s,margin-left " + Blockly.FieldTextInput.ANIMATION_TIME + "s");
  b.style.transition = d;
  f.style.transition = "font-size " + Blockly.FieldTextInput.ANIMATION_TIME + "s";
  f.style.fontSize = Blockly.BlockSvg.FIELD_TEXTINPUT_FONTSIZE_FINAL + "pt";
  b.style.boxShadow = "0px 0px 0px 4px " + Blockly.Colours.fieldShadow
...
}; Blockly.FieldTextInput.GECKO_KEYCODE_WHITELIST = [97, 99, 118, 120]; Blockly.FieldTextInput.prototype.onHtmlInputChange_ = function(a) {
  if ("keypress" === a.type && this.restrictor_) {
    var b = !1;
    if (goog.userAgent.GECKO) {
      var c = a.charCode;
      if (32 > c || 127 == c) b = !0;
      else if (a.metaKey || a.ctrlKey) b = -1 < Blockly.FieldTextInput.GECKO_KEYCODE_WHITELIST.indexOf(c)
    } else c = a.keyCode;
  ...
  b = a.value;
  b !== a.oldValue_ ? (a.oldValue_ = b, this.setText(b), this.validate_()) : goog.userAgent.WEBKIT && this.sourceBlock_.render();
  this.resizeEditor_()
  ...
  var a = this.sourceBlock_.workspace.scale,
    b = Blockly.WidgetDiv.DIV;
  if (Blockly.BlockSvg.FIELD_TEXTINPUT_EXPAND_PAST_TRUNCATION) {
    var c = Blockly.utils.measureText(Blockly.FieldTextInput.htmlInput_.style.fontSize, Blockly.FieldTextInput.htmlInput_.style.fontFamily, Blockly.FieldTextInput.htmlInput_.style.fontWeight, Blockly.FieldTextInput.htmlInput_.value);
    c += Blockly.FieldTextInput.TEXT_MEASURE_PADDING_MAGIC;
    c *= a
  } else c = this.sourceBlock_.getHeightWidth().width * a;
  c = Math.max(c, Blockly.BlockSvg.FIELD_WIDTH_MIN_EDIT * a);
  c = Math.min(c, Blockly.BlockSvg.FIELD_WIDTH_MAX_EDIT * a);
  b.style.width = c / a + 1 + "px";
  b.style.height = Blockly.BlockSvg.FIELD_HEIGHT + 1 + "px";
  b.style.transform = "scale(" + a + ")";
  var d = this.sourceBlock_.getHeightWidth().width;
  b.style.marginLeft = -.5 * (c - d * a) + "px";
  d = this.getBorderRadius() + .5;
  b.style.borderRadius = d + "px";
  Blockly.FieldTextInput.htmlInput_.style.borderRadius = d + "px";
  d = this.sourceBlock_.getColourTertiary();
  b.style.borderColor = d;
  d = this.getAbsoluteXY_();
  d.x -= a / 2;
  d.y -= a / 2;
  this.sourceBlock_.RTL && (d.x += c, d.x -= b.offsetWidth * a, d.x += 1 * a);
  d.y += 1 * a;
  goog.userAgent.GECKO && Blockly.WidgetDiv.DIV.style.top && (d.x += 2 * a, d.y += 1 * a);
  goog.userAgent.WEBKIT && (d.y -= 1 * a);
  b.style.left = d.x + "px";
  b.style.top = d.y + "px"
}; Blockly.FieldTextInput.prototype.getBorderRadius = function() {
  return this.sourceBlock_.getOutputShape() == Blockly.OUTPUT_SHAPE_ROUND ? Blockly.BlockSvg.NUMBER_FIELD_CORNER_RADIUS: Blockly.BlockSvg.TEXT_FIELD_CORNER_RADIUS
}; Blockly.FieldTextInput.prototype.widgetDispose_ = function() {
  var a = this;
  return function() {
    var b = Blockly.WidgetDiv.DIV,
      c = Blockly.FieldTextInput.htmlInput_,
      d = c.value;
    if (a.sourceBlock_) if (d = a.callValidator(d), null === d) d = c.defaultValue;
    else if (a.onFinishEditing_) a.onFinishEditing_(d);
    a.setText(d);
    a.sourceBlock_.rendered && a.sourceBlock_.render();
    Blockly.unbindEvent_(c.onKeyDownWrapper_);
    Blockly.unbindEvent_(c.onKeyUpWrapper_);
    Blockly.unbindEvent_(c.onKeyPressWrapper_);
    Blockly.unbindEvent_(c.onInputWrapper_);
    c.dropDownArrowMouseWrapper_ && Blockly.unbindEvent_(c.dropDownArrowMouseWrapper_);
    a.workspace_.removeChangeListener(c.onWorkspaceChangeWrapper_);
    Blockly.Events.setGroup(!1);
    c.style.fontSize = Blockly.BlockSvg.FIELD_TEXTINPUT_FONTSIZE_INITIAL + "pt";
    b.style.boxShadow = "";
    a.sourceBlock_ && (c = a.sourceBlock_.getHeightWidth(), b.style.width = c.width + 1 + "px", b.style.height = c.height + 1 + "px");
...
}; goog.inherits(Blockly.FieldAngle, Blockly.FieldTextInput); Blockly.FieldAngle.ROUND = 15; Blockly.FieldAngle.HALF = 50; Blockly.FieldAngle.CLOCKWISE = !0; Blockly.FieldAngle.OFFSET = 90; Blockly.FieldAngle.WRAP = 180; Blockly.FieldAngle.RADIUS = Blockly.FieldAngle.HALF - 1; Blockly.FieldAngle.prototype.dispose_ = function() {
  var a = this;
  return function() {
    Blockly.FieldAngle.superClass_.dispose_.call(a)();
    a.gauge_ = null;
    a.clickWrapper_ && Blockly.unbindEvent_(a.clickWrapper_);
    a.moveWrapper_ && Blockly.unbindEvent_(a.moveWrapper_)
  }
  ...
  this.line_ = Blockly.utils.createSvgElement("line", {
    ...
    a);
  for (var b = 0; 360 > b; b += 15) Blockly.utils.createSvgElement("line", {
      x1: Blockly.FieldAngle.HALF + Blockly.FieldAngle.RADIUS,
      y1: Blockly.FieldAngle.HALF,
      x2: Blockly.FieldAngle.HALF + Blockly.FieldAngle.RADIUS - (0 == b % 45 ? 10 : 5),
      y2: Blockly.FieldAngle.HALF,
      "class": "blocklyAngleMarks",
      transform: "rotate(" + b + "," + Blockly.FieldAngle.HALF + "," + Blockly.FieldAngle.HALF + ")"
    },
    a);
  ...
  this.clickWrapper_ = Blockly.bindEvent_(a, "click", this,
    function() {
      Blockly.WidgetDiv.hide();
      Blockly.DropDownDiv.hide();
      Blockly.unbindEvent_(this.moveWrapper_)
    });
  this.moveWrapper_ = Blockly.bindEvent_(a, "mousemove", this, this.onMouseMove);
  this.updateGraph_()
  ...
  this.colour_ = a;
  this.sourceBlock_ && this.sourceBlock_.setColour(a, this.sourceBlock_.getColourSecondary(), this.sourceBlock_.getColourTertiary())
...
}; goog.inherits(Blockly.FieldDropdown, Blockly.Field); Blockly.FieldDropdown.CHECKMARK_OVERHANG = 25; Blockly.FieldDropdown.prototype.CURSOR = "default"; Blockly.FieldDropdown.prototype.selectedItem = null; Blockly.FieldDropdown.prototype.value_ = ""; Blockly.FieldDropdown.prototype.imageElement_ = null; Blockly.FieldDropdown.prototype.imageJson_ = null; Blockly.FieldDropdown.prototype.init = function() {
  if (!this.fieldGroup_) {
    this.arrowSize_ = 12;
    this.arrowX_ = 0;
    this.arrowY_ = 11;
  ...
  var a = Blockly.DropDownDiv.getContentDiv(),
    b = this,
    c = new goog.ui.Menu;
  c.setRightToLeft(this.sourceBlock_.RTL);
  for (var d = this.getOptions(), e = 0; e < d.length; e++) {
    var f = d[e][0],
      g = d[e][1];
    if ("object" == typeof f) {
      var h = new Image(f.width, f.height);
      h.src = f.src;
      h.alt = f.alt || "";
      f = h
    }
    f = new goog.ui.MenuItem(f);
  ...
  c.getHandler().listen(c.getElement(), goog.events.EventType.TOUCHSTART,
    function(a) {
      this.getOwnerControl(a.target).handleMouseDown(a)
    });
  c.getHandler().listen(c.getElement(), goog.events.EventType.TOUCHEND,
    function(a) {
      this.getOwnerControl(a.target).performActionInternal(a)
    });
  c.render(a);
  a = c.getElement();
  Blockly.utils.addClass(a, "blocklyDropdownMenu");
  goog.style.getSize(a).height = a.scrollHeight;
  d = this.sourceBlock_.isShadow() ? this.sourceBlock_.parentBlock_.getColour() : this.sourceBlock_.getColour();
  Blockly.DropDownDiv.setColour(d, this.sourceBlock_.getColourTertiary());
  d = this.sourceBlock_.isShadow() ? this.sourceBlock_.parentBlock_.getCategory() : this.sourceBlock_.getCategory();
  Blockly.DropDownDiv.setCategory(d);
  e = this.sourceBlock_.workspace.scale;
  g = this.size_.width;
  d = this.size_.height;
  g *= e;
  d *= e;
  e = this.fieldGroup_.getBoundingClientRect();
  g = e.left + g / 2;
  d = e.top + d;
  e = e.top;
  Blockly.DropDownDiv.setBoundsElement(this.sourceBlock_.workspace.getParentSvg().parentNode);
  Blockly.DropDownDiv.show(this, g, d, g, e, this.onHide.bind(this));
  c.setAllowAutoFocus(!0);
  a.focus();
  this.disableColourChange_ || (this.sourceBlock_.isShadow() ? (this.savedPrimary_ = this.sourceBlock_.getColour(), this.sourceBlock_.setColour(this.sourceBlock_.getColourTertiary(), this.sourceBlock_.getColourSecondary(), this.sourceBlock_.getColourTertiary())) : this.box_ && this.box_.setAttribute("fill", this.sourceBlock_.getColourTertiary()))
}; Blockly.FieldDropdown.prototype.onHide = function() {
  this.dropDownOpen_ = !1; ! this.disableColourChange_ && this.sourceBlock_ && (this.sourceBlock_.isShadow() ? this.sourceBlock_.setColour(this.savedPrimary_, this.sourceBlock_.getColourSecondary(), this.sourceBlock_.getColourTertiary()) : this.box_ && this.box_.setAttribute("fill", this.sourceBlock_.getColour()))
  ...
  if (null !== a && a !== this.value_) {
    ...
    this.selectedItem && (this.selectedItem.setChecked(!1), this.selectedItem = null);
    this.value_ = a;
  ...
  null !== a && a !== this.text_ && (this.text_ = a, this.updateTextNode_(), this.textElement_ && (this.textElement_.setAttribute("class", this.textElement_.getAttribute("class") + " blocklyDropdownText"), this.textElement_.parentNode.appendChild(this.arrow_)), this.sourceBlock_ && this.sourceBlock_.rendered && (this.sourceBlock_.render(), this.sourceBlock_.bumpNeighbours_()))
}; Blockly.FieldDropdown.prototype.positionArrow = function(a) {
  if (!this.arrow_) return 0;
  this.arrowX_ = this.sourceBlock_.RTL ? this.arrowSize_ - Blockly.BlockSvg.DROPDOWN_ARROW_PADDING: a + Blockly.BlockSvg.DROPDOWN_ARROW_PADDING / 2;
  a = this.arrowSize_ + Blockly.BlockSvg.DROPDOWN_ARROW_PADDING;
...
}; goog.inherits(Blockly.FieldIconMenu, Blockly.Field); Blockly.FieldIconMenu.DROPDOWN_WIDTH = 168; Blockly.FieldIconMenu.savedPrimary_ = null; Blockly.FieldIconMenu.prototype.init = function(a) {
  this.arrowX_ = 18;
  this.arrowY_ = 10;
  a.RTL && (this.arrowX_ = -this.arrowX_ - 12);
  ...
  Blockly.FieldIconMenu.superClass_.init.call(this, a)
}; Blockly.FieldIconMenu.prototype.CURSOR = "default"; Blockly.FieldIconMenu.prototype.setValue = function(a) {
  null !== a && a !== this.value_ && (this.sourceBlock_ && Blockly.Events.isEnabled() && Blockly.Events.fire(new Blockly.Events.Change(this.sourceBlock_, "field", this.name, this.value_, a)), this.value_ = a, this.setParentFieldImage(this.getSrcForValue(this.value_)))
}; Blockly.FieldIconMenu.prototype.setParentFieldImage = function(a) {
  if (this.sourceBlock_ && this.sourceBlock_.parentBlock_) for (var b = this.sourceBlock_.parentBlock_,
                                                                  c = 0,
                                                                  d; d = b.inputList[c]; c++) for (var e = 0,
                                                                                                     f; f = d.fieldRow[e]; e++) if (f instanceof Blockly.FieldImage) {
    f.setValue(a);
    return
  }
}; Blockly.FieldIconMenu.prototype.getValue = function() {
  return this.value_
}; Blockly.FieldIconMenu.prototype.getSrcForValue = function(a) {
  for (var b = 0,
         c; c = this.icons_[b]; b++) if (c.value === a) return c.src
  ...
  if (!Blockly.DropDownDiv.hideIfOwner(this)) {
    ...
    for (var b = 0,
      ...
      if ("placeholder" == c.type) {
        ...
        d.setAttribute("class", "blocklyDropDownPlaceholder");
        ...
        d.setAttribute("class", "blocklyDropDownButton");
        d.title = c.alt;
        d.style.width = c.width + "px";
        d.style.height = c.height + "px";
        var e = this.sourceBlock_.getColour();
        c.value == this.getValue() && (e = this.sourceBlock_.getColourTertiary(), d.setAttribute("aria-selected", "true"));
        d.style.backgroundColor = e;
        d.style.borderColor = this.sourceBlock_.getColourTertiary();
        Blockly.bindEvent_(d, "click", this, this.buttonClick_);
        Blockly.bindEvent_(d, "mouseup", this, this.buttonClick_);
        Blockly.bindEvent_(d, "mousedown", d,
          function(a) {
            this.setAttribute("class", "blocklyDropDownButton blocklyDropDownButtonHover");
            a.preventDefault()
          });
        Blockly.bindEvent_(d, "mouseover", d,
          function() {
            this.setAttribute("class", "blocklyDropDownButton blocklyDropDownButtonHover");
            a.setAttribute("aria-activedescendant", this.id)
          });
        Blockly.bindEvent_(d, "mouseout", d,
          function() {
    ...
    a.style.width = Blockly.FieldIconMenu.DROPDOWN_WIDTH + "px";
    ...
    b = -(Blockly.BlockSvg.MIN_BLOCK_Y * b) - Blockly.BlockSvg.FIELD_Y_OFFSET * b;
    Blockly.DropDownDiv.showPositionedByBlock(this, this.sourceBlock_, this.onHide_.bind(this), b) || this.arrowIcon_.setAttribute("transform", "translate(" + (this.arrowX_ + Blockly.DropDownDiv.ARROW_SIZE / 1.5 + 1) + "," + (this.arrowY_ + Blockly.DropDownDiv.ARROW_SIZE / 1.5) + ") rotate(180)")
  }
  ...
  null !== a && (this.text_ = a)
}; Blockly.FieldImage.prototype.render_ = function() {}; Blockly.FieldImage.prototype.updateWidth = function() {}; Blockly.FieldTextDropdown = function(a, b, c, d) {
  this.menuGenerator_ = b;
  Blockly.FieldDropdown.prototype.trimOptions_.call(this);
  Blockly.FieldTextDropdown.superClass_.constructor.call(this, a, c, d);
  this.addArgType("textdropdown")
}; goog.inherits(Blockly.FieldTextDropdown, Blockly.FieldTextInput); Blockly.FieldTextDropdown.prototype.init = function() {
  Blockly.FieldTextDropdown.superClass_.init.call(this);
  this.arrow_ || (this.arrowSize_ = 12, this.arrowX_ = 0, this.arrowY_ = 11, this.arrow_ = Blockly.utils.createSvgElement("image", {
    height: this.arrowSize_ + "px",
    width: this.arrowSize_ + "px"
  }), this.arrow_.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", Blockly.mainWorkspace.options.pathToMedia + "dropdown-arrow-dark.svg"), this.arrow_.style.cursor = "pointer", this.fieldGroup_.appendChild(this.arrow_), this.mouseUpWrapper_ = Blockly.bindEvent_(this.arrow_, "mouseup", this, this.showDropdown_));
  this.disableColourChange_ = !0
}; Blockly.FieldTextDropdown.prototype.dispose = function() {
  this.mouseUpWrapper_ && (Blockly.unbindEvent_(this.mouseUpWrapper_), this.mouseUpWrapper_ = null, Blockly.Touch.clearTouchIdentifier());
  Blockly.FieldTextDropdown.superClass_.dispose.call(this)
}; Blockly.FieldTextDropdown.prototype.showEditor_ = function() {
  this.dropDownOpen_ || Blockly.FieldTextDropdown.superClass_.showEditor_.call(this, null, null, !0,
    function() {
      Blockly.WidgetDiv.hide();
      this.showDropdown_();
      Blockly.Touch.clearTouchIdentifier()
    })
}; Blockly.FieldTextDropdown.prototype.getOptions_ = Blockly.FieldDropdown.prototype.getOptions_; Blockly.FieldTextDropdown.prototype.positionArrow = Blockly.FieldDropdown.prototype.positionArrow; Blockly.FieldTextDropdown.prototype.showDropdown_ = Blockly.FieldDropdown.prototype.showEditor_; Blockly.FieldTextDropdown.prototype.onHide = Blockly.FieldDropdown.prototype.onHide; Blockly.FieldNumber = function(a, b, c, d, e) {
  b = this.getNumRestrictor(b, c, d);
  a = a && !isNaN(a) ? String(a) : "0";
  Blockly.FieldNumber.superClass_.constructor.call(this, a, e, b);
  this.addArgType("number")
}; goog.inherits(Blockly.FieldNumber, Blockly.FieldTextInput); Blockly.FieldNumber.DROPDOWN_WIDTH = 168; Blockly.FieldNumber.DROPDOWN_Y_PADDING = 8; Blockly.FieldNumber.NUMPAD_BUTTONS = "789456123.0- ".split(""); Blockly.FieldNumber.NUMPAD_DELETE_ICON = 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40"><path d="M28.89,11.45H16.79a2.86,2.86,0,0,0-2,.84L9.09,18a2.85,2.85,0,0,0,0,4l5.69,5.69a2.86,2.86,0,0,0,2,.84h12.1a2.86,2.86,0,0,0,2.86-2.86V14.31A2.86,2.86,0,0,0,28.89,11.45ZM27.15,22.73a1,1,0,0,1,0,1.41,1,1,0,0,1-.71.3,1,1,0,0,1-.71-0.3L23,21.41l-2.73,2.73a1,1,0,0,1-1.41,0,1,1,0,0,1,0-1.41L21.59,20l-2.73-2.73a1,1,0,0,1,0-1.41,1,1,0,0,1,1.41,0L23,18.59l2.73-2.73a1,1,0,1,1,1.42,1.41L24.42,20Z" fill="' + Blockly.Colours.numPadText + '"/></svg>'; Blockly.FieldNumber.activeField_ = null; Blockly.FieldNumber.prototype.getNumRestrictor = function(a, b, c) {
  this.setConstraints_(a, b, c);
  a = "[\\d]";
  this.decimalAllowed_ && (a += "|[\\.]");
  this.negativeAllowed_ && (a += "|[-]");
  return new RegExp(a)
}; Blockly.FieldNumber.prototype.setConstraints_ = function(a, b, c) {
  ...
  var a = goog.userAgent.MOBILE || goog.userAgent.ANDROID || goog.userAgent.IPAD;
  Blockly.FieldNumber.superClass_.showEditor_.call(this, !1, a);
  a && this.showNumPad_()
  ...
  a.style.width = Blockly.FieldNumber.DROPDOWN_WIDTH + "px";
  this.position_()
  ...
  var c = this.getAbsoluteXY_(),
    d = c.x + b.width / 2,
    b = c.y + b.height + Blockly.FieldNumber.DROPDOWN_Y_PADDING,
    a = c.y - Blockly.BlockSvg.MIN_BLOCK_Y * a - Blockly.BlockSvg.FIELD_Y_OFFSET * a;
  Blockly.DropDownDiv.setBoundsElement(this.sourceBlock_.workspace.getParentSvg().parentNode);
  Blockly.DropDownDiv.show(this, d, b, d, a, this.onHide_.bind(this))
}; Blockly.FieldNumber.prototype.addButtons_ = function(a) {
  for (var b = Blockly.FieldNumber.NUMPAD_BUTTONS,
         c = 0,
         d; d = b[c]; c++) {
    ...
    e.title = d;
    e.innerHTML = d;
    Blockly.bindEvent_(e, "mousedown", e, Blockly.FieldNumber.numPadButtonTouch);
    if ("." != d || this.decimalAllowed_) if ("-" != d || this.negativeAllowed_) if (" " != d || this.negativeAllowed_)" " == d && this.negativeAllowed_ && e.setAttribute("style", "visibility: hidden");
    else continue;
    else continue;
  ...
  c.src = Blockly.FieldNumber.NUMPAD_DELETE_ICON;
  b.appendChild(c);
  Blockly.bindEvent_(b, "mousedown", null, Blockly.FieldNumber.numPadEraseButtonTouch);
  a.appendChild(b)
}; Blockly.FieldNumber.numPadButtonTouch = function() {
  var a = this.innerHTML,
    b = Blockly.FieldTextInput.htmlInput_.value,
    c = Blockly.FieldTextInput.htmlInput_.selectionEnd,
    a = b.slice(0, Blockly.FieldTextInput.htmlInput_.selectionStart) + a + b.slice(c);
  Blockly.FieldNumber.updateDisplay_(a);
  Blockly.Touch.clearTouchIdentifier()
}; Blockly.FieldNumber.numPadEraseButtonTouch = function() {
  var a = Blockly.FieldTextInput.htmlInput_.value,
    b = Blockly.FieldTextInput.htmlInput_.selectionStart,
    c = Blockly.FieldTextInput.htmlInput_.selectionEnd,
    d = a.slice(0, b) + a.slice(c);
  0 == c - b && (d = a.slice(0, b - 1) + a.slice(b));
  Blockly.FieldNumber.updateDisplay_(d);
  Blockly.Touch.clearTouchIdentifier()
}; Blockly.FieldNumber.updateDisplay_ = function(a) {
  Blockly.FieldTextInput.htmlInput_.value = a;
  Blockly.FieldNumber.superClass_.resizeEditor_.call(Blockly.FieldNumber.activeField_);
  Blockly.FieldTextInput.htmlInput_.setSelectionRange(a.length, a.length);
  ...
  Blockly.DropDownDiv.content_.removeAttribute("role");
  Blockly.DropDownDiv.content_.removeAttribute("aria-haspopup")
}; Blockly.FieldNumberDropdown = function(a, b, c, d, e, f) {
  this.setConstraints_ = Blockly.FieldNumber.prototype.setConstraints_;
  c = Blockly.FieldNumber.prototype.getNumRestrictor.call(this, c, d, e);
  Blockly.FieldNumberDropdown.superClass_.constructor.call(this, a, b, f, c);
  this.addArgType("numberdropdown")
}; goog.inherits(Blockly.FieldNumberDropdown, Blockly.FieldTextDropdown); Blockly.Variables = {}; Blockly.Variables.NAME_TYPE = Blockly.VARIABLE_CATEGORY_NAME; Blockly.Variables.allUsedVariables = function(a) {
  if (a instanceof Blockly.Block) var b = a.getDescendants();
  else if (a instanceof Blockly.Workspace || a instanceof Blockly.WorkspaceSvg) b = a.getAllBlocks();
  else throw "Not Block or Workspace: " + a;
  var c = Blockly.Variables.noVariableText();
  a = Object.create(null);
  for (var d = 0; d < b.length; d++) {
    var e = b[d].getVars();
    if (e) for (var f = 0; f < e.length; f++) {
      var g = e[f];
      g && g.toLowerCase() != c && (a[g.toLowerCase()] = g)
    }
  }
  b = [];
  ...
  c.push(d);
  for (d = 0; d < b.length; d++) if (Blockly.Blocks.data_variable) {
    a = goog.dom.createDom("block");
    a.setAttribute("type", "data_variable");
    a.setAttribute("gap", 8);
    a.setAttribute("id", "VAR_" + b[d].name);
    var e = goog.dom.createDom("field", null, b[d].name);
    e.setAttribute("name", "VARIABLE");
    e.setAttribute("variableType", b[d].type);
    e.setAttribute("id", b[d].getId());
    a.appendChild(e);
    c.push(a)
  }
  1 < c.length && (c[c.length - 1].setAttribute("gap", 24), Blockly.Blocks.data_setvariableto && (a = goog.dom.createDom("block"), a.setAttribute("type", "data_setvariableto"), a.setAttribute("gap", 8), a.appendChild(Blockly.Variables.createVariableDom_(b[0])), a.appendChild(Blockly.Variables.createTextDom_()), c.push(a)), Blockly.Blocks.data_changevariableby && (a = goog.dom.createDom("block"), a.setAttribute("type", "data_changevariableby"), a.setAttribute("gap", 8), a.appendChild(Blockly.Variables.createVariableDom_(b[0])), a.appendChild(Blockly.Variables.createMathNumberDom_()), c.push(a)), Blockly.Blocks.data_showvariable && (a = goog.dom.createDom("block"), a.setAttribute("type", "data_showvariable"), a.setAttribute("gap", 8), a.appendChild(Blockly.Variables.createVariableDom_(b[0])), c.push(a)), Blockly.Blocks.data_hidevariable && (a = goog.dom.createDom("block"), a.setAttribute("type", "data_hidevariable"), a.appendChild(Blockly.Variables.createVariableDom_(b[0])), c.push(a)));
  return c
}; Blockly.Variables.createValueDom_ = function(a) {
  var b = goog.dom.createDom("value");
  b.setAttribute("name", a);
  return b
}; Blockly.Variables.createShadowDom_ = function(a) {
  var b = goog.dom.createDom("shadow");
  b.setAttribute("type", a);
  return b
}; Blockly.Variables.createVariableDom_ = function(a) {
  var b = goog.dom.createDom("field", null, a.name);
  b.setAttribute("name", "VARIABLE");
  b.setAttribute("variableType", a.type);
  b.setAttribute("id", a.getId());
  return b
}; Blockly.Variables.createTextDom_ = function() {
  var a = Blockly.Variables.createValueDom_("VALUE"),
    b = Blockly.Variables.createShadowDom_("text"),
    c = goog.dom.createDom("field", null, "0");
  ...
  var a = Blockly.Variables.createValueDom_("VALUE"),
    b = Blockly.Variables.createShadowDom_("math_number"),
    c = goog.dom.createDom("field", null, "1");
  ...
  var c = function(d) {
    Blockly.Variables.promptName(Blockly.Msg.NEW_VARIABLE_TITLE, d,
      function(d) {
        if (d) if (a.getVariable(d)) Blockly.alert(Blockly.Msg.VARIABLE_ALREADY_EXISTS.replace("%1", d.toLowerCase()),
          function() {
            c(d)
          });
        else if (Blockly.Procedures.isLegalName_(d, a)) {
          var e = a.createVariable(d),
            g = a.getFlyout(),
            e = "VAR_" + e.name;
          g.setCheckboxState && g.setCheckboxState(e, !0);
          b && b(d)
        } else Blockly.alert(Blockly.Msg.PROCEDURE_ALREADY_EXISTS.replace("%1", d.toLowerCase()),
          function() {
            c(d)
          });
        else b && b(null)
  ...
  if (d) {
    ...
    for (var e = 0; e < a.length; e++) if (c && goog.string.caseInsensitiveEquals(a[e].name, b)) {
      c = !1;
      break
    }
  }
  ...
  if (this.sourceBlock_ && this.sourceBlock_.workspace) {
    ...
    if (e) var f = e.name;
      ...
      if (c == Blockly.RENAME_VARIABLE_ID) {
        var g = this.getText();
        Blockly.hideChaff();
        Blockly.Variables.promptName(Blockly.Msg.RENAME_VARIABLE_TITLE.replace("%1", g), g,
          function(a) {
  ...
  return a.toLowerCase() == b.toLowerCase()
}; Blockly.Procedures = {}; Blockly.Procedures.NAME_TYPE = Blockly.PROCEDURE_CATEOGORY_NAME; Blockly.Procedures.allProcedures = function(a) {
  a = a.getAllBlocks();
  ...
  Blockly.Blocks.procedures_report && (d = goog.dom.createDom("block"), d.setAttribute("type", "procedures_report"), d.setAttribute("gap", 16), c.push(d));
...
}; Blockly.FlyoutButton.MARGIN = 40; Blockly.FlyoutButton.prototype.width = 0; Blockly.FlyoutButton.prototype.height = 40; Blockly.FlyoutButton.prototype.onMouseUpWrapper_ = null; Blockly.FlyoutButton.prototype.createDom = function() {
  ...
  c.setAttribute("y", this.height / 2);
  ...
  this.svgGroup_ && (goog.dom.removeNode(this.svgGroup_), this.svgGroup_ = null);
  this.targetWorkspace_ = this.svgBackground_ = this.parentToolbox_ = null
}; Blockly.Flyout.prototype.setParentToolbox = function(a) {
  this.parentToolbox_ = a
}; Blockly.Flyout.prototype.getWidth = function() {
  return this.parentToolbox_ ? this.parentToolbox_.getWidth() : this.DEFAULT_WIDTH
  ...
  if (this.isVisible()) {
    ...
    if (a) {
      ...
      var c = a.absoluteTop;
      this.toolboxPosition_ == Blockly.TOOLBOX_AT_BOTTOM && (c += a.viewHeight, c -= this.height_);
  ...
  for (var e = 0,
    ...
    f.moveBy(k, c);
    d += h.width + b[e];
    h = Blockly.utils.createSvgElement("rect", {
        "fill-opacity": 0
      },
      null);
    h.tooltip = f;
  ...
  } else "button" == f.type && (f = f.button, g = f.createDom(), f.moveTo(d, c), f.show(), this.listeners_.push(Blockly.bindEventWithChecks_(g, "mousedown", this, this.onMouseDown_)), this.buttons_.push(f), d += f.width + b[e])
}; Blockly.HorizontalFlyout.prototype.isDragTowardWorkspace = function(a) {
  a = Math.atan2(a.y, a.x) / Math.PI * 180;
  var b = !1,
    c = this.dragAngleRange_;
  this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP ? a < 90 + c && a > 90 - c && (b = !0) : a > -90 - c && a < -90 + c && (b = !0);
  return b
  ...
  var c = Blockly.utils.getInjectionDivXY_(c),
  ...
  e = Blockly.utils.getInjectionDivXY_(e);
  ...
  if (this.height_ != b) {
    for (c = 0; d = a[c]; c++) {
      ...
      if (d.flyoutRect_) {
        ...
        d.flyoutRect_.setAttribute("x", this.RTL ? f.x - e.width: f.x); (e = d.startHat_ ? Blockly.BlockSvg.START_HAT_HEIGHT: 0) && d.moveBy(0, e);
        d.flyoutRect_.setAttribute("y", f.y)
      }
    }
    this.height_ = b;
  ...
  this.checkboxes_ = []
}; goog.inherits(Blockly.VerticalFlyout, Blockly.Flyout); Blockly.VerticalFlyout.prototype.autoClose = !1; Blockly.VerticalFlyout.prototype.DEFAULT_WIDTH = 250; Blockly.VerticalFlyout.prototype.CHECKBOX_SIZE = 20; Blockly.VerticalFlyout.prototype.CHECKMARK_PATH = "M" + Blockly.VerticalFlyout.prototype.CHECKBOX_SIZE / 4 + " " + Blockly.VerticalFlyout.prototype.CHECKBOX_SIZE / 2 + "L" + 5 * Blockly.VerticalFlyout.prototype.CHECKBOX_SIZE / 12 + " " + 2 * Blockly.VerticalFlyout.prototype.CHECKBOX_SIZE / 3 + "L" + 3 * Blockly.VerticalFlyout.prototype.CHECKBOX_SIZE / 4 + " " + Blockly.VerticalFlyout.prototype.CHECKBOX_SIZE / 3; Blockly.VerticalFlyout.prototype.CHECKBOX_CORNER_RADIUS = 5; Blockly.VerticalFlyout.prototype.CHECKBOX_MARGIN = Blockly.Flyout.prototype.MARGIN; Blockly.VerticalFlyout.prototype.CHECKBOX_SPACE_X = Blockly.VerticalFlyout.prototype.CHECKBOX_SIZE + 2 * Blockly.VerticalFlyout.prototype.CHECKBOX_MARGIN; Blockly.VerticalFlyout.prototype.init = function(a) {
  Blockly.VerticalFlyout.superClass_.init.call(this, a);
  this.workspace_.scale = a.scale
}; Blockly.VerticalFlyout.prototype.createDom = function(a) {
  Blockly.VerticalFlyout.superClass_.createDom.call(this, a);
  this.defs_ = Blockly.utils.createSvgElement("defs", {},
    this.svgGroup_);
  a = Blockly.utils.createSvgElement("clipPath", {
  ...
  var b = this.SCROLLBAR_PADDING,
    ...
    d = this.getWidth() - this.SCROLLBAR_PADDING;
  return {
    viewHeight: c,
    viewWidth: d,
    contentHeight: a.height * this.workspace_.scale + 2 * this.MARGIN,
  ...
  var b = this.getMetrics_();
  b && (goog.isNumber(a.y) && (this.workspace_.scrollY = -b.contentHeight * a.y), this.workspace_.translate(this.workspace_.scrollX + b.absoluteLeft, this.workspace_.scrollY + b.absoluteTop), this.clipRect_.setAttribute("height", b.viewHeight + "px"), this.clipRect_.setAttribute("width", b.viewWidth + "px"))
  ...
  if (this.isVisible()) {
    ...
    if (a) {
      ...
      if (this.parentToolbox_) {
        var b = this.parentToolbox_.HtmlDiv.offsetLeft;
        var c = this.parentToolbox_.HtmlDiv.offsetTop + this.parentToolbox_.getHeight()
      } else b = this.toolboxPosition_ == Blockly.TOOLBOX_AT_RIGHT ? a.viewWidth - this.width_: 0,
        c = 0;
      this.height_ = a.viewHeight - c;
  ...
  for (var a = 0,
         b; b = this.checkboxes_[a]; a++) b.block.flyoutCheckbox = null,
    goog.dom.removeNode(b.svgRoot);
  this.checkboxes_ = []
}; Blockly.VerticalFlyout.prototype.addBlockListeners_ = function(a, b, c) {
  Blockly.VerticalFlyout.superClass_.addBlockListeners_.call(this, a, b, c);
  b.flyoutCheckbox && this.listeners_.push(Blockly.bindEvent_(b.flyoutCheckbox.svgRoot, "mousedown", null, this.checkboxClicked_(b.flyoutCheckbox)))
}; Blockly.VerticalFlyout.prototype.layout_ = function(a, b) {
  for (var c = this.MARGIN,
         d = this.getWidth() / this.workspace_.scale, e = c, f = 0, g; g = a[f]; f++) if ("block" == g.type) {
    g = g.block;
    for (var h = g.getDescendants(), k = 0, l; l = h[k]; k++) l.isInFlyout = !0;
    h = g.getSvgRoot();
    k = g.getHeightWidth();
    l = g.getRelativeToSurfaceXY().x;
    var m = d - this.MARGIN;
    l = this.RTL ? m - l: c;
    g.hasCheckboxInFlyout() && (this.createCheckbox_(g, c, e, k), l = this.RTL ? l - (this.CHECKBOX_SIZE + this.CHECKBOX_MARGIN) : l + (this.CHECKBOX_SIZE + this.CHECKBOX_MARGIN));
    g.moveBy(l, e + (g.startHat_ ? Blockly.BlockSvg.START_HAT_HEIGHT: 0));
    l = this.createRect_(g, this.RTL ? l - k.width: l, e, k, f);
    this.addBlockListeners_(h, g, l);
    e += k.height + b[f] + (g.startHat_ ? Blockly.BlockSvg.START_HAT_HEIGHT: 0)
  } else "button" == g.type && (g = g.button, h = g.createDom(), g.moveTo(c, e), g.show(), this.listeners_.push(Blockly.bindEventWithChecks_(h, "mousedown", this, this.onMouseDown_)), this.buttons_.push(g), e += g.height + b[f])
}; Blockly.VerticalFlyout.prototype.createRect_ = function(a, b, c, d, e) {
...
}; Blockly.VerticalFlyout.prototype.createCheckbox_ = function(a, b, c, d) {
  var e = Blockly.VerticalFlyout.getCheckboxState(a.id),
    f = a.getSvgRoot(),
    g = this.CHECKBOX_SIZE + this.CHECKBOX_MARGIN;
  b = this.RTL ? this.getWidth() / this.workspace_.scale - g: b;
  c = Blockly.utils.createSvgElement("g", {
      "class": "blocklyFlyoutCheckbox",
      transform: "translate(" + b + ", " + (c + d.height / 2 - this.CHECKBOX_SIZE / 2) + ")"
    },
    null);
  Blockly.utils.createSvgElement("rect", {
  ...
  e && Blockly.utils.addClass(d.svgRoot, "checked");
  a.flyoutCheckbox = d;
  this.workspace_.getCanvas().insertBefore(c, f);
  this.checkboxes_.push(d)
}; Blockly.VerticalFlyout.prototype.checkboxClicked_ = function(a) {
  return function(b) {
    this.setCheckboxState(a.block.id, !a.clicked);
    b.stopPropagation();
    b.preventDefault()
  }.bind(this)
}; Blockly.VerticalFlyout.prototype.setCheckboxState = function(a, b) {
  for (var c = 0; c < this.checkboxes_.length; c++) {
    var d = this.checkboxes_[c];
    if (d.block.id === a) {
      if (d.clicked === b) break;
      c = d.clicked;
      d.clicked = b;
      d.clicked ? Blockly.utils.addClass(d.svgRoot, "checked") : Blockly.utils.removeClass(d.svgRoot, "checked");
      Blockly.Events.fire(new Blockly.Events.Change(d.block, "checkbox", null, c, b));
      break
    }
  }
  ...
  var b = !1,
    c = this.dragAngleRange_;
  if (this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT) a < c && a > -c && (b = !0);
  else if (a < -180 + c || a > 180 - c) b = !0;
  return b
  ...
  if (!c) throw "originBlock is not rendered.";
  var c = Blockly.utils.getInjectionDivXY_(c),
    d = this.workspace_.scale,
    e = b.getMetrics();
  this.toolboxPosition_ == Blockly.TOOLBOX_AT_RIGHT && (e = e.viewWidth - this.width_, c.x += e / d - e);
  this.parentToolbox_ && (c.y += this.parentToolbox_.getHeight() / b.scale - this.parentToolbox_.getHeight(), e = this.parentToolbox_.getWidth() / b.scale - this.parentToolbox_.getWidth(), c.x = this.toolboxPosition_ == Blockly.TOOLBOX_AT_RIGHT ? c.x + e: c.x - e);
  e = this.workspace_.scrollY;
  c.y += e / d - e;
  a = Blockly.Xml.blockToDom(a);
  ...
  e.x += b.scrollX / b.scale - b.scrollX;
  e.y += b.scrollY / b.scale - b.scrollY;
  a.moveBy((d * c.x - b.scale * e.x) / b.scale, (d * c.y - b.scale * e.y) / b.scale);
  return a
...
}; Blockly.VerticalFlyout.prototype.reflowInternal_ = function() {}; Blockly.VerticalFlyout.getCheckboxState = function() {
  return ! 1
...
}; Blockly.Toolbox.prototype.width = 250; Blockly.Toolbox.prototype.height = 0; Blockly.Toolbox.prototype.selectedItem_ = null; Blockly.Toolbox.prototype.init = function() {
  var a = this.workspace_,
  ...
  var a = this.getSelectedItem();
  a && a.getContents() && this.flyout_.show(a.getContents())
}; Blockly.Toolbox.prototype.getSelectedItem = function() {
  return this.selectedItem_
}; Blockly.Toolbox.prototype.setSelectedItem = function(a) {
  if (this.selectedItem_) {
    if (this.selectedItem_ == a) return;
    this.selectedItem_.setSelected(!1)
  }
  this.selectedItem_ = a;
  null != this.selectedItem_ && (this.selectedItem_.setSelected(!0), this.flyout_.show(a.getContents()), this.flyout_.scrollToStart())
}; Blockly.Toolbox.prototype.setSelectedItemFactory = function(a) {
  return function() {
    this.setSelectedItem(a);
    Blockly.Touch.clearTouchIdentifier()
  }
}; Blockly.Toolbox.CategoryMenu = function(a, b) {
  this.parent_ = a;
  this.height_ = 0;
  this.parentHtml_ = b;
  this.createDom();
...
}; Blockly.Toolbox.CategoryMenu.prototype.populate = function(a) {
  if (a) {
    this.dispose();
    this.createDom();
    for (var b = [], c = 0, d; d = a.childNodes[c]; c++) d.tagName && "CATEGORY" == d.tagName.toUpperCase() && b.push(d);
    a = Math.ceil(b.length / 2);
    for (c = 0; c < a; c += 1) {
      d = b[c];
      var e = goog.dom.createDom("tr", "scratchCategoryMenuRow");
      this.table.appendChild(e);
      d && this.categories_.push(new Blockly.Toolbox.Category(this, e, d));
      b[c + a] && this.categories_.push(new Blockly.Toolbox.Category(this, e, b[c + a]))
    }
    this.height_ = this.table.offsetHeight
  }
}; Blockly.Toolbox.CategoryMenu.prototype.dispose = function() {
  for (var a = 0,
         b; b = this.categories_[a]; a++) b.dispose();
  this.categories_ = [];
  this.table && (goog.dom.removeNode(this.table), this.table = null)
}; Blockly.Toolbox.Category = function(a, b, c) {
  this.parent_ = a;
  this.parentHtml_ = b;
  this.name_ = c.getAttribute("name");
  this.setColour(c);
  this.custom_ = c.getAttribute("custom");
  this.contents_ = [];
  this.custom_ || this.parseContents_(c);
  this.createDom()
}; Blockly.Toolbox.Category.prototype.dispose = function() {
  this.item_ && (goog.dom.removeNode(this.item_), this.item = null);
  this.contents_ = this.parentHtml_ = this.parent_ = null
}; Blockly.Toolbox.Category.prototype.createDom = function() {
  var a = this.parent_.parent_;
  ...
  Blockly.bindEvent_(this.item_, "mousedown", a, a.setSelectedItemFactory(this))
}; Blockly.Toolbox.Category.prototype.setSelected = function(a) {
  this.item_.className = a ? "scratchCategoryMenuItem categorySelected": "scratchCategoryMenuItem"
}; Blockly.Toolbox.Category.prototype.parseContents_ = function(a) {
  for (var b = 0,
         c; c = a.childNodes[b]; b++) if (c.tagName) switch (c.tagName.toUpperCase()) {
    case "BLOCK":
    case "SHADOW":
    case "LABEL":
    case "BUTTON":
    case "SEP":
    case "TEXT":
      this.contents_.push(c)
  }
}; Blockly.Toolbox.Category.prototype.getContents = function() {
  return this.custom_ ? this.custom_: this.contents_
}; Blockly.Toolbox.Category.prototype.setColour = function(a) {
  var b = a.getAttribute("colour");
  a = a.getAttribute("secondaryColour");
  goog.isString(b) ? (b.match(/^#[0-9a-fA-F]{6}$/) ? this.colour_ = b: this.colour_ = Blockly.hueToRgb(b), a.match(/^#[0-9a-fA-F]{6}$/) ? this.secondaryColour_ = a: this.secondaryColour_ = Blockly.hueToRgb(a), this.hasColours_ = !0) : this.secondaryColour_ = this.colour_ = "#000000"
  ...
  if (!Blockly.Css.styleSheet_) {
    ...
    for (d in Blockly.Colours) Blockly.Colours.hasOwnProperty(d) && (c = c.replace(new RegExp("\\$colour\\_" + d, "g"), Blockly.Colours[d]));
...
}; Blockly.WidgetDiv.show = function(a, b, c, d, e) {
  Blockly.WidgetDiv.hide();
  Blockly.WidgetDiv.owner_ = a;
  Blockly.WidgetDiv.dispose_ = c;
  Blockly.WidgetDiv.disposeAnimationFinished_ = d;
  Blockly.WidgetDiv.disposeAnimationTimerLength_ = e;
...
}; Blockly.WidgetDiv.hide = function(a) {
  Blockly.WidgetDiv.disposeAnimationTimer_ ? (window.clearTimeout(Blockly.WidgetDiv.disposeAnimationTimer_), Blockly.WidgetDiv.disposeAnimationFinished_ && Blockly.WidgetDiv.disposeAnimationFinished_(), Blockly.WidgetDiv.disposeAnimationFinished_ = null, Blockly.WidgetDiv.disposeAnimationTimer_ = null, Blockly.WidgetDiv.owner_ = null, Blockly.WidgetDiv.hideAndClearDom_()) : Blockly.WidgetDiv.isVisible() && (Blockly.WidgetDiv.dispose_ && Blockly.WidgetDiv.dispose_(), Blockly.WidgetDiv.dispose_ = null, Blockly.WidgetDiv.disposeAnimationFinished_ && !a ? Blockly.WidgetDiv.disposeAnimationTimer_ = window.setTimeout(Blockly.WidgetDiv.hide, 1E3 * Blockly.WidgetDiv.disposeAnimationTimerLength_) : (Blockly.WidgetDiv.disposeAnimationFinished_ && Blockly.WidgetDiv.disposeAnimationFinished_(), Blockly.WidgetDiv.disposeAnimationFinished_ = null, Blockly.WidgetDiv.owner_ = null, Blockly.WidgetDiv.hideAndClearDom_()), Blockly.Events.setGroup(!1))
  ...
  var c = Blockly.utils.createSvgElement("svg", {
    ...
    f = Blockly.utils.createSvgElement("filter", {
      ...
      d);
  b.stackGlowBlur = Blockly.utils.createSvgElement("feGaussianBlur", {
      "in": "SourceGraphic",
      stdDeviation: Blockly.STACK_GLOW_RADIUS
    },
    f);
  var g = Blockly.utils.createSvgElement("feComponentTransfer", {
      result: "outBlur"
    },
    f);
  ...
  Blockly.utils.createSvgElement("feGaussianBlur", {
    ...
    f);
  g = Blockly.utils.createSvgElement("feComponentTransfer", {
      result: "outBlur"
    },
    f);
  Blockly.utils.createSvgElement("feFuncA", {
  ...
  Blockly.utils.createSvgElement("feComposite", {
    ...
    f);
  g = Blockly.utils.createSvgElement("pattern", {
  ...
  b.languageTree && (a.toolbox_ ? a.toolbox_.init(a) : a.flyout_ && (a.flyout_.init(a), a.flyout_.show(b.languageTree.childNodes), a.flyout_.scrollToStart(), b.horizontalLayout ? (a.scrollY = a.flyout_.height_, b.toolboxPosition == Blockly.TOOLBOX_AT_BOTTOM && (a.scrollY *= -1)) : (a.scrollX = a.flyout_.width_, b.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT && (a.scrollX *= -1)), a.translate(a.scrollX, a.scrollY)));
...
var CLOSURE_DEFINES = {
  ...
  Blockly.mainWorkspace.options.readOnly || Blockly.utils.isTargetInput(a) || (27 == a.keyCode ? (Blockly.hideChaff(), Blockly.DropDownDiv.hide()) : 8 == a.keyCode || 46 == a.keyCode ? (a.preventDefault(), Blockly.mainWorkspace.isDragging()) : (a.altKey || a.ctrlKey || a.metaKey) && !Blockly.mainWorkspace.isDragging() && (Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() && (67 == a.keyCode ? (Blockly.hideChaff(), Blockly.copy_(Blockly.selected)) : 88 == a.keyCode && (Blockly.copy_(Blockly.selected), Blockly.hideChaff(), Blockly.selected.dispose(!0, !0))), 86 == a.keyCode ? Blockly.clipboardXml_ && (Blockly.Events.setGroup(!0), Blockly.clipboardSource_.paste(Blockly.clipboardXml_), Blockly.Events.setGroup(!1)) : 90 == a.keyCode && (Blockly.hideChaff(), Blockly.mainWorkspace.undo(a.shiftKey))))
